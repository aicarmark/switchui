...
public class CalendarProvider2 extends SQLiteContentProvider implements OnAccountsUpdateListener {
    ...
    /*2012-11-26, add by amt_jiayuanyuan for SWITCHUITWO-38 */
...
//                qb.setTables(Tables.ATTENDEES + ", " + Tables.EVENTS + ", " + Tables.CALENDARS);
    ...
    protected Uri insertInTransaction(Uri uri, ContentValues values, boolean callerIsSyncAdapter) {
        ...
        switch (match) {
            ...
            case EVENTS:
                ...
                // Being Motorola for SWITCHUITWO-69 at 2012-11-27
                // Generate _sync_id for local calendar event
                if (calAccount != null
                        && CalendarDatabaseHelper.LOCAL_CALENDAR_ACCOUNT_TYPE
                                .equals(calAccount.type)
                        && CalendarDatabaseHelper.LOCAL_CALENDAR_ACCOUNT_NAME
                                .equals(calAccount.name)) {
                ...
                if (updatedValues.containsKey(Events.ORIGINAL_SYNC_ID)
                    ...
                    long originalId = getOriginalId(updatedValues
                            .getAsString(Events.ORIGINAL_SYNC_ID), calendar_id);
                    //End Motorola
                    if (originalId != -1) {
    ...
    private long getOriginalId(String originalSyncId, long calendarId) {
        if (TextUtils.isEmpty(originalSyncId)) {
            return -1;
        }
        ...
        Cursor c = null;
        try {
            // Begin Motorola for SWITCHUITWO-69 at 2012-11-27
            ...
            c = mDb.rawQuery("SELECT " + Events._ID +
                    ...
                    new String[] { originalSyncId, String.valueOf(calendarId) });
            // End Motorola
