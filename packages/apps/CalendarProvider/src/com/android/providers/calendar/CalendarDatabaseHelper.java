...
/* package */ class CalendarDatabaseHelper extends SQLiteOpenHelper {
    ...
    // Begin Motorola
    private static final String EVENTS_AND_CONFINFO_CLEANUP_TIGGER_SQL =
            EVENTS_CLEANUP_TRIGGER_SQL +
            "DELETE FROM " + ConferenceCallInfo.TABLE_NAME +
                " WHERE " + ConferenceCallInfo.ColumnNames.ASSOCIATED_EVENT_ID + "=" +
                    "old." + CalendarContract.Events._ID + ";";
    // End Motorola
    ...
    private DatabaseUtils.InsertHelper mConfCallInfoInserter;
    // End Motorola
    ...
    public long confCallInfoInserter(ContentValues values) {
        return mConfCallInfoInserter.insert(values);
    }
    // End Motorola
    ...
    public void onOpen(SQLiteDatabase db) {
        ...
        mConfCallInfoInserter = new DatabaseUtils.InsertHelper(db, ConferenceCallInfo.TABLE_NAME);
    ...
    private void bootstrapDB(SQLiteDatabase db) {
        ...
        // ConfInfo tables
        db.execSQL(ConferenceCallInfo.CREATE_TABLE);
        db.execSQL(ConferenceCallInfo.CREATE_INDEX);

        // CalendarAttributes table
        createCalendarAttributesTable(db);
    ...
    protected void duplicateEvent(final long id) {
        ...
        copyEventRelatedTables(db, newId, id);
            ...
            if (Log.isLoggable(TAG, Log.VERBOSE)) {
                Log.v(TAG, "Catch SQLiteDoneException!!!");
            }
            return;
        }
    }
    ...
    /**
     * Begin Motorola Added Functions
     */
    ...
    private void createCalendarAttributesTable(SQLiteDatabase db) {
