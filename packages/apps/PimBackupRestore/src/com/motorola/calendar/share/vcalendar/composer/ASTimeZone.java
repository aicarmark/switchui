...
public class ASTimeZone {
    ...
    public static ASTimeZone newFromTimeZone(TimeZone timezone, int year) {
        ...
        if (timezone != null) {
            ...
            // modified by amt_jiayuanyuan 2012-12-18 SWITCHUITWO-258 begin
           ...
           /* String standardName = timezone.getDisplayName(false, TimeZone.LONG);
            ...
            String standardName = timezone.getID();
            String daylightName = timezone.getID();
            // modified by amt_jiayuanyuan 2012-12-18 SWITCHUITWO-258 end
