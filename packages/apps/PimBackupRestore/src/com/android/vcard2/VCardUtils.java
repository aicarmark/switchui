...
// BEGIN MOT ICS UPMERGE, a18246, 11/22/2011
import java.util.Locale; // Motorola, a5705c, 10/18/2011, IKDEFYPLUS-1866
// END MOT ICS UPMERGE
...
public class VCardUtils {
    ...
    static {
        ...
        sKnownPhoneTypesMap_ItoS.put(Phone.TYPE_TELEX, VCardConstants.PARAM_TYPE_TLX);
        sKnownPhoneTypeMap_StoI.put(VCardConstants.PARAM_TYPE_TLX, Phone.TYPE_TELEX);
        

        sKnownPhoneTypesMap_ItoS.put(Phone.TYPE_HOME, VCardConstants.PARAM_TYPE_HOME);
        sKnownPhoneTypeMap_StoI.put(VCardConstants.PARAM_TYPE_HOME, Phone.TYPE_HOME);
        sKnownPhoneTypesMap_ItoS.put(Phone.TYPE_WORK, VCardConstants.PARAM_TYPE_WORK);
        sKnownPhoneTypeMap_StoI.put(VCardConstants.PARAM_TYPE_WORK, Phone.TYPE_WORK);
        sKnownPhoneTypesMap_ItoS.put(Phone.TYPE_MOBILE, VCardConstants.PARAM_TYPE_CELL);
        sKnownPhoneTypeMap_StoI.put(VCardConstants.PARAM_TYPE_CELL, Phone.TYPE_MOBILE);

        sKnownPhoneTypesMap_ItoS.put(Phone.TYPE_OTHER, VCardConstants.PARAM_PHONE_EXTRA_TYPE_OTHER);
        sKnownPhoneTypeMap_StoI.put(VCardConstants.PARAM_PHONE_EXTRA_TYPE_OTHER, Phone.TYPE_OTHER);
        sKnownPhoneTypesMap_ItoS.put(Phone.TYPE_CALLBACK, VCardConstants.PARAM_PHONE_EXTRA_TYPE_CALLBACK);
        sKnownPhoneTypeMap_StoI.put(VCardConstants.PARAM_PHONE_EXTRA_TYPE_CALLBACK,
                Phone.TYPE_CALLBACK);
        sKnownPhoneTypesMap_ItoS.put(Phone.TYPE_COMPANY_MAIN, VCardConstants.PARAM_PHONE_EXTRA_TYPE_COMPANY_MAIN);
        sKnownPhoneTypeMap_StoI.put(
                VCardConstants.PARAM_PHONE_EXTRA_TYPE_COMPANY_MAIN, Phone.TYPE_COMPANY_MAIN);
        sKnownPhoneTypesMap_ItoS.put(Phone.TYPE_RADIO, VCardConstants.PARAM_PHONE_EXTRA_TYPE_RADIO);
        sKnownPhoneTypeMap_StoI.put(VCardConstants.PARAM_PHONE_EXTRA_TYPE_RADIO, Phone.TYPE_RADIO);
        sKnownPhoneTypesMap_ItoS.put(Phone.TYPE_TTY_TDD, VCardConstants.PARAM_PHONE_EXTRA_TYPE_TTY_TDD);
        sKnownPhoneTypeMap_StoI.put(VCardConstants.PARAM_PHONE_EXTRA_TYPE_TTY_TDD,
                Phone.TYPE_TTY_TDD);
        sKnownPhoneTypesMap_ItoS.put(Phone.TYPE_ASSISTANT, VCardConstants.PARAM_PHONE_EXTRA_TYPE_ASSISTANT);
        sKnownPhoneTypeMap_StoI.put(VCardConstants.PARAM_PHONE_EXTRA_TYPE_ASSISTANT,
                Phone.TYPE_ASSISTANT);
        sKnownPhoneTypesMap_ItoS.put(Phone.TYPE_MMS,VCardConstants.PARAM_TYPE_MSG);
        sKnownPhoneTypeMap_StoI.put(VCardConstants.PARAM_TYPE_MSG,
                Phone.TYPE_MMS);
                ...
                if (typeStringUpperCase.equals(VCardConstants.PARAM_TYPE_PREF)) {
                    ...
                    if (tmp != null) {
                        ...
                        if ((typeCandidate == Phone.TYPE_PAGER
                            ...
                            type = tmp;
                        } else if(typeCandidate == Phone.TYPE_WORK && type == Phone.TYPE_PAGER) {
    ...
    public static int getPhoneNumberFormat(final int vcardType) {
        if (VCardConfig.isJapaneseDevice(vcardType)) {
            ...
            // BEGIN MOT ICS UPMERGE, a18246, 11/22/2011
            // BEGIN Motorola, a5705c, 10/18/2011, IKDEFYPLUS-1866
            return PhoneNumberUtils.getFormatTypeForLocale(Locale.getDefault());
            // END IKDEFYPLUS-1866
            // END MOT ICS UPMERGE
        }
    }
