...
public class VCardConstants {
    ...
    public static final String PROPERTY_CATETORIES = "CATEGORIES";
    public static final String PROPERTY_PHOTO_FILE_ID = "X-MOT-FILEID";
    
    public static final String PROPERTY_IMPP = "IMPP";  // RFC 4770 (vCard 3.0) and vCard 4.0
    // BEGIN MOT ICS UPMERGE, a18246, 11/23/2011
    public static final String PROPERTY_GEO = "GEO";//IKMAIN-15417, Support GEO for 36508
    // END MOT ICS UPMERGE
    ...
    public static final class Geo {
        ...
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/geo";

        /**
         * The latitude and longitude value for Geo.
         * <P>Type: TEXT</P>
         */
        public static final String LATITUDE = "data1";
        public static final String LONGITUDE = "data2";
    }
