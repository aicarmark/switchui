...
public class EventRecurrenceFormatter
{
    ...
    private static String dayToString(int day) {
        // modified by amt_sunli 2012-12-10 SWITCHUITWO-169 begin
        return DateUtils.getDayOfWeekString(dayToUtilDay(day), DateUtils.LENGTH_MEDIUM);
        // modified by amt_sunli 2012-12-10 SWITCHUITWO-169 end
    }
