...
public class SelectSyncedCalendarsMultiAccountAdapter extends CursorTreeAdapter implements
    ...
    protected void bindChildView(View view, Context context, Cursor cursor, boolean isLastChild) {
        ...
        // Begin Motorola
        String accountType = cursor.getString(TYPE_COLUMN);
        ...
        // End Motorola
            // Begin Motorola - IKHSS6-1843
            button.setVisibility(View.VISIBLE);
            view.setEnabled(true);
            // End Motorola - IKHSS6-1843
    ...
    protected Cursor getChildrenCursor(Cursor groupCursor) {
        ...
        // Begin Motorola
        String cookie = new StringBuilder(account).append(accountType).toString();
        //Get all the calendars for just this account.
        Cursor childCursor = mChildrenCursors.get(cookie);
        new RefreshCalendars(groupCursor.getPosition(), account, accountType, cookie).run();
        // End Motorola
        return childCursor;
    }
    ...
    private class RefreshCalendars implements Runnable {
        ...
        public RefreshCalendars(int token, String account, String accountType,
        		String cookie/* added by Motorola*/) {
            mToken = token;
            mAccount = account;
        ...
        public void run() {
            ...
            if(mRefresh) {
                ...
                // End Motorola - IKHSS7-8425
                mRefreshRunnable = new RefreshCalendars(mToken, mAccount, mAccountType, mCookie);
                mView.postDelayed(mRefreshRunnable, REFRESH_DELAY);
            }
