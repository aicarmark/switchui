...
public class SimpleWeekView extends View {
    ...
    protected static int MINI_LUNAR_DAY_NUMBER_TEXT_SIZE = 15;
    ...
    protected Paint mLunarNumPaint;
    ...
    protected void initView() {
        ...
        //for Lunar Calendar
        mLunarNumPaint = new Paint();
        mLunarNumPaint.setAntiAlias(true);
        mLunarNumPaint.setTextSize(MINI_LUNAR_DAY_NUMBER_TEXT_SIZE);
        mLunarNumPaint.setColor(mFocusMonthColor);
        mLunarNumPaint.setStyle(Style.FILL);
        mLunarNumPaint.setTextAlign(Align.LEFT);
    }
