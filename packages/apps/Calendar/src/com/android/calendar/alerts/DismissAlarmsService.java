...
public class DismissAlarmsService extends IntentService {
    ...
    public void onHandleIntent(Intent intent) {
        ...
        if (notificationId != -1) {
            ...
            /* Modified by songshun.zhang for SWITCHUITWO-565 on 2013-1-22 */
            // AlertService.updateLockScreenNotification(getContentResolver(), "", 0);
            AlertService.updateAlertNotification(getBaseContext());
            /* Modified end */
			// End motorola
        }
