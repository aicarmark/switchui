...
public class VCalComposer_V1 implements VCalComposer {
    ...
    */
    ...
    private void appendEventBody() {
        ...
        mBuilder.appendProperty(ICalNames.PROP_SUMMARY, VCalUtils.encodeQuotedPrintable(mCe.summary));
        mBuilder.appendProperty(ICalNames.PROP_LOCATION, VCalUtils.encodeQuotedPrintable(mCe.location));
        mBuilder.appendProperty(ICalNames.PROP_DESCRIPTION, VCalUtils.encodeQuotedPrintable(mCe.description));
