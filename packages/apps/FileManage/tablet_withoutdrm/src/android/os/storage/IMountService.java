...
public interface IMountService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IMountService {
        private static class Proxy implements IMountService {
            ...
            /**
             * Validate external storage with given derived key.
               Returns an int consistent with MountServiceResultCode
             */
            public int validateVolume(String mountPoint, String dkey, boolean sync)
                ...
                try {
                    ...
                    mRemote.transact(Stub.TRANSACTION_validateVolume, _data, _reply, 0);
                    _reply.readException();
             ...
             */
            public void setPlayNotificationSounds(boolean value) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
            ...
            public void unmountVolumeForUSBFlashDrive(String mountPoint, boolean force)
                   throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    ...
                    _data.writeString(mountPoint);
                    _data.writeInt((force ? 1 : 0));
                    mRemote.transact(Stub.TRANSACTION_unmountVolumeForUSBFlashDrive, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void mountUSBDiskIfAny() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
                    mRemote.transact(Stub.TRANSACTION_mountUSBDiskIfAny, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            /**
             * return volume which has secure container(where external app been installed)
             */
            public String getSecureContainerVolume() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
                    mRemote.transact(Stub.TRANSACTION_getSecureContainerVolume, _data, _reply, 0);
                    _reply.readException();
                    _result = _reply.readString();
                } finally {
                    _reply.recycle();
             ...
             */
            public boolean isVolumeRemovable(String mountPoint) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                boolean _result;
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
                    _data.writeString(mountPoint);
                    mRemote.transact(Stub.TRANSACTION_isVolumeRemovable, _data, _reply, 0);
                    _reply.readException();
                    _result = 0 != _reply.readInt();
                } finally {
                    _reply.recycle();
     ...
     */
    int validateVolume(String mountPoint, String dkey, boolean sync) throws RemoteException;
    /** END Motorola, Ken Chen/e50324, 01/18/2011, IKMAIN-15352 */
    ...
    //add an api for unmounting USB flash drive
    void unmountVolumeForUSBFlashDrive(String mountPoint, boolean force) throws RemoteException;
