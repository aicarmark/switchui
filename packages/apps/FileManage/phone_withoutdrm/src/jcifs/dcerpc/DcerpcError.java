...
public interface DcerpcError {
    ...
    static final int[] DCERPC_FAULT_CODES = { DCERPC_FAULT_OTHER,
	    DCERPC_FAULT_ACCESS_DENIED, DCERPC_FAULT_CANT_PERFORM,
	    DCERPC_FAULT_NDR, DCERPC_FAULT_INVALID_TAG,
	    DCERPC_FAULT_CONTEXT_MISMATCH, DCERPC_FAULT_OP_RNG_ERROR,
