...
public class lsarpc {
	...
	public LsarQueryInformationPolicy(rpc.policy_handle handle,
		short level, NdrObject info) {
	    this.handle = handle;
	    this.level = level;
	    this.info = info;
	}
	...
	public LsarLookupSids(rpc.policy_handle handle, LsarSidArray sids,
		LsarRefDomainList domains, LsarTransNameArray names,
		short level, int count) {
	    this.handle = handle;
	    this.sids = sids;
	...
	public LsarOpenPolicy2(String system_name,
		LsarObjectAttributes object_attributes, int desired_access,
	...
	public LsarQueryInformationPolicy2(rpc.policy_handle handle,
		short level, NdrObject info) {
	    this.handle = handle;
	    this.level = level;
	    this.info = info;
