...
class SmbComOpenAndXResponse extends AndXServerMessageBlock {
    ...
    int fid, fileAttributes, dataSize, grantedAccess, fileType, deviceState,
	    action, serverFid;
    long lastWriteTime;
	...
	return new String("SmbComOpenAndXResponse[" + super.toString()
		+ ",fid=" + fid + ",fileAttributes=" + fileAttributes
		+ ",lastWriteTime=" + lastWriteTime + ",dataSize=" + dataSize
		+ ",grantedAccess=" + grantedAccess + ",fileType=" + fileType
		+ ",deviceState=" + deviceState + ",action=" + action
		+ ",serverFid=" + serverFid + "]");
    }
}
