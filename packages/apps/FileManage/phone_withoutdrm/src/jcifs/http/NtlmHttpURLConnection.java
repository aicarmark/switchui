 ...
 * services.
 * 
 * Please read <a href="../../../httpclient.html">Using jCIFS NTLM
...
public class NtlmHttpURLConnection extends HttpURLConnection {
	...
	if (authMethod == null)
	    return null;
	NtlmMessage message = (authorization != null) ? new Type2Message(
		Base64.decode(authorization)) : null;
	reconnect();
	if (message == null) {
		...
		try {
		    ...
		    PasswordAuthentication auth = Authenticator
			    .requestPasswordAuthentication(null, port,
				    protocol, "", authMethod);
		    if (auth == null)
			return null;
