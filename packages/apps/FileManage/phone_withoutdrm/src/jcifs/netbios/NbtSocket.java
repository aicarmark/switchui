...
public class NbtSocket extends Socket {
    ...
    public NbtSocket(NbtAddress address, int port, InetAddress localAddr,
	...
	soTimeout = Config
		.getInt("jcifs.netbios.soTimeout", DEFAULT_SO_TIMEOUT);
	connect();
    }
	...
	return "NbtSocket[addr=" + address + ",port=" + super.getPort()
