...
public class UniAddress {
	...
	QueryThread(Sem sem, String host, int type, String scope,
		InetAddress svr) {
    ...
    public static UniAddress getByName(String hostname,
	    boolean possibleNTDomainOrWorkgroup) throws UnknownHostException {
	UniAddress[] addrs = UniAddress.getAllByName(hostname,
	...
	for (i = 0; i < resolveOrder.length; i++) {
		...
		case RESOLVER_BCAST:
			...
			addr = NbtAddress
				.getByName(hostname, 0x20, null, baddr);
		    }
		    break;
		case RESOLVER_DNS:
	...
	return obj instanceof UniAddress
