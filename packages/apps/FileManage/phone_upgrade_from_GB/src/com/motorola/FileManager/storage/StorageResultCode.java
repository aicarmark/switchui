...
/**
 * Class that provides access to constants returned from StorageManager and
 * lower level MountService APIs.
 * 
 * @hide
 */
public class StorageResultCode {
    ...
    // BEGIN MOT GB UPMERGE, A22569, 01/19/2011 / Port IKMAIN-10935
    // BEGIN Motorola, a22569, 12/21/2010, IKMAIN-10935
    /**
     * Operation failed: Not allowed by Storage Card policy
     * 
     * @see android.os.storage.StorageManager
     */
    public static final int OperationFailedNotAllowed = -8;
    // END IKMAIN-10935
    // END MOT GB UPMERGE
}
