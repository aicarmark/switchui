...
public abstract class StorageEventListener {
     ...
     * 
     * @param connected
     *            true if the USB mass storage is connected.
     */
     ...
     * 
     * @param path
     *            the filesystem path for the storage
     * @param oldState
     *            the old state as returned by
     *            {@link android.os.Environment#getExternalStorageState()}.
     * @param newState
     *            the old state as returned by
     *            {@link android.os.Environment#getExternalStorageState()}.
     */
