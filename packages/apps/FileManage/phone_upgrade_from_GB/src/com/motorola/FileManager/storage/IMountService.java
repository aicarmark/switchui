...
public interface IMountService extends IInterface {
	...
	private static class Proxy implements IMountService {
		...
		try {
		    _data.writeInterfaceToken(DESCRIPTOR);
		    mRemote.transact(
			    Stub.TRANSACTION_isUsbMassStorageConnected, _data,
			    _reply, 0);
		    _reply.readException();
		...
		try {
		    ...
		    mRemote.transact(Stub.TRANSACTION_setUsbMassStorageEnabled,
			    _data, _reply, 0);
		    _reply.readException();
		} finally {
		    _reply.recycle();
		...
		try {
		    _data.writeInterfaceToken(DESCRIPTOR);
		    mRemote.transact(Stub.TRANSACTION_isUsbMassStorageEnabled,
			    _data, _reply, 0);
		    _reply.readException();
		    _result = 0 != _reply.readInt();
		} finally {
	    ...
	    /** BEGIN Motorola, Ken Chen/e50324, 01/18/2011, IKMAIN-15352 */
	    /**
	     * Validate external storage with given derived key. Returns an int
	     * consistent with MountServiceResultCode
	     */
	    public int validateVolume(String mountPoint, String dkey,
		...
		try {
		    ...
		    _data.writeString(dkey);
		    _data.writeInt((sync ? 1 : 0));
		    mRemote.transact(Stub.TRANSACTION_validateVolume, _data,
			    _reply, 0);
		    _reply.readException();
	    ...
	    /** END Motorola, Ken Chen/e50324, 01/18/2011, IKMAIN-15352 */
	    /**
		...
		try {
		    _data.writeInterfaceToken(DESCRIPTOR);
		    _data.writeString(mountPoint);
		    mRemote.transact(Stub.TRANSACTION_mountVolume, _data,
			    _reply, 0);
		    _reply.readException();
		    _result = _reply.readInt();
		} finally {
		...
		try {
		    ...
		    mRemote.transact(Stub.TRANSACTION_unmountVolume, _data,
			    _reply, 0);
		    _reply.readException();
		} finally {
		    _reply.recycle();
		...
		try {
		    _data.writeInterfaceToken(DESCRIPTOR);
		    _data.writeString(mountPoint);
		    mRemote.transact(Stub.TRANSACTION_formatVolume, _data,
			    _reply, 0);
		    _reply.readException();
		    _result = _reply.readInt();
		} finally {
		...
		try {
		    ...
		    mRemote.transact(Stub.TRANSACTION_getStorageUsers, _data,
			    _reply, 0);
		    _reply.readException();
		...
		try {
		    _data.writeInterfaceToken(DESCRIPTOR);
		    _data.writeString(mountPoint);
		    mRemote.transact(Stub.TRANSACTION_getVolumeState, _data,
			    _reply, 0);
		    _reply.readException();
		...
		try {
		    ...
		    mRemote.transact(Stub.TRANSACTION_createSecureContainer,
			    _data, _reply, 0);
		    _reply.readException();
		    _result = _reply.readInt();
		} finally {
		...
		try {
		    ...
		    _data.writeString(id);
		    _data.writeInt((force ? 1 : 0));
		    mRemote.transact(Stub.TRANSACTION_destroySecureContainer,
			    _data, _reply, 0);
		    _reply.readException();
		    _result = _reply.readInt();
		} finally {
		...
		try {
		    _data.writeInterfaceToken(DESCRIPTOR);
		    _data.writeString(id);
		    mRemote.transact(Stub.TRANSACTION_finalizeSecureContainer,
			    _data, _reply, 0);
		    _reply.readException();
		    _result = _reply.readInt();
		} finally {
		...
		try {
		    ...
		    _data.writeString(key);
		    _data.writeInt(ownerUid);
		    mRemote.transact(Stub.TRANSACTION_mountSecureContainer,
			    _data, _reply, 0);
		    _reply.readException();
		    _result = _reply.readInt();
		} finally {
		...
		try {
		    ...
		    _data.writeString(id);
		    _data.writeInt((force ? 1 : 0));
		    mRemote.transact(Stub.TRANSACTION_unmountSecureContainer,
			    _data, _reply, 0);
		    _reply.readException();
		    _result = _reply.readInt();
		} finally {
		...
		try {
		    _data.writeInterfaceToken(DESCRIPTOR);
		    _data.writeString(id);
		    mRemote.transact(Stub.TRANSACTION_isSecureContainerMounted,
			    _data, _reply, 0);
		    _reply.readException();
		    _result = 0 != _reply.readInt();
		} finally {
		...
		try {
		    ...
		    mRemote.transact(Stub.TRANSACTION_renameSecureContainer,
			    _data, _reply, 0);
		    _reply.readException();
		    _result = _reply.readInt();
		} finally {
		...
		try {
		    _data.writeInterfaceToken(DESCRIPTOR);
		    _data.writeString(id);
		    mRemote.transact(Stub.TRANSACTION_getSecureContainerPath,
			    _data, _reply, 0);
		    _reply.readException();
		    _result = _reply.readString();
		} finally {
		...
		try {
		    _data.writeInterfaceToken(DESCRIPTOR);
		    mRemote.transact(Stub.TRANSACTION_getSecureContainerList,
			    _data, _reply, 0);
		    _reply.readException();
		...
		try {
		    _data.writeInterfaceToken(DESCRIPTOR);
		    _data.writeStrongBinder((observer != null ? observer
			    .asBinder() : null));
		...
		try {
		    _data.writeInterfaceToken(DESCRIPTOR);
		    mRemote.transact(Stub.TRANSACTION_finishMediaUpdate, _data,
			    _reply, 0);
		    _reply.readException();
		} finally {
		    _reply.recycle();
		...
		try {
		    ...
		    _data.writeString(key);
		    _data.writeStrongBinder((token != null ? token.asBinder()
			    : null));
		    _data.writeInt(nonce);
		    mRemote.transact(Stub.TRANSACTION_mountObb, _data, _reply,
			    0);
		    _reply.readException();
		} finally {
		    _reply.recycle();
		...
		try {
		    ...
		    _data.writeStrongBinder((token != null ? token.asBinder()
			    : null));
		    _data.writeInt(nonce);
		    mRemote.transact(Stub.TRANSACTION_unmountObb, _data,
			    _reply, 0);
		    _reply.readException();
		} finally {
		    _reply.recycle();
		...
		try {
		    _data.writeInterfaceToken(DESCRIPTOR);
		    _data.writeString(filename);
		    mRemote.transact(Stub.TRANSACTION_isObbMounted, _data,
			    _reply, 0);
		    _reply.readException();
		    _result = 0 != _reply.readInt();
		} finally {
		...
		try {
		    _data.writeInterfaceToken(DESCRIPTOR);
		    _data.writeString(filename);
		    mRemote.transact(Stub.TRANSACTION_getMountedObbPath, _data,
			    _reply, 0);
		    _reply.readException();
		    _result = _reply.readString();
		} finally {
	    ...
	    // BEGIN MOT GB UPMERGE, A22569, 12/30/2010
	    /**
	     * Returns true if media notification sounds are enabled.
	     */
	    public boolean getPlayNotificationSounds() throws RemoteException {
		Parcel _data = Parcel.obtain();
		Parcel _reply = Parcel.obtain();
		boolean _result;
		try {
		    _data.writeInterfaceToken(DESCRIPTOR);
		    mRemote.transact(
			    Stub.TRANSACTION_getPlayNotificationSounds, _data,
			    _reply, 0);
		    _reply.readException();
		    _result = 0 != _reply.readInt();
		} finally {
	     ...
	     */
	    public void setPlayNotificationSounds(boolean value)
		    throws RemoteException {
		Parcel _data = Parcel.obtain();
		Parcel _reply = Parcel.obtain();
		try {
		    ...
		    mRemote.transact(
			    Stub.TRANSACTION_setPlayNotificationSounds, _data,
			    _reply, 0);
		    _reply.readException();
		} finally {
		    _reply.recycle();
	    ...
	    /**
	     * get supported volume list, /mnt/sdcard, /mnt/sdcard-ext
	     */
		...
		try {
		    _data.writeInterfaceToken(DESCRIPTOR);
		    mRemote.transact(Stub.TRANSACTION_getVolumeList, _data,
			    _reply, 0);
		    _reply.readException();
		    _result = _reply.createStringArray();
		} finally {
	    ...
	    // add an api for unmounting USB flash drive
	    public void unmountVolumeForUSBFlashDrive(String mountPoint,
		...
		try {
		    ...
		    _data.writeInt((force ? 1 : 0));
		    mRemote.transact(
			    Stub.TRANSACTION_unmountVolumeForUSBFlashDrive,
			    _data, _reply, 0);
		    _reply.readException();
		} finally {
		    _reply.recycle();
	    ...
	    // add an api for mounting USB disk
	    public void mountUSBDiskIfAny() throws RemoteException {
		Parcel _data = Parcel.obtain();
		Parcel _reply = Parcel.obtain();
		try {
		    _data.writeInterfaceToken(DESCRIPTOR);
		    mRemote.transact(Stub.TRANSACTION_mountUSBDiskIfAny, _data,
			    _reply, 0);
		    _reply.readException();
		} finally {
		    _reply.recycle();
	    ...
	    /**
	     * return volume which has secure container(where external app been
	     * installed)
	     */
	    public String getSecureContainerVolume() throws RemoteException {
		Parcel _data = Parcel.obtain();
		Parcel _reply = Parcel.obtain();
		String _result;
		try {
		    _data.writeInterfaceToken(DESCRIPTOR);
		    mRemote.transact(Stub.TRANSACTION_getSecureContainerVolume,
			    _data, _reply, 0);
		    _reply.readException();
		    _result = _reply.readString();
		} finally {
	    ...
	    /**
	     * check if given mount point mapping to removable storage
	     */
	    public boolean isVolumeRemovable(String mountPoint)
		    throws RemoteException {
		Parcel _data = Parcel.obtain();
		Parcel _reply = Parcel.obtain();
		boolean _result;
		try {
		    _data.writeInterfaceToken(DESCRIPTOR);
		    _data.writeString(mountPoint);
		    mRemote.transact(Stub.TRANSACTION_isVolumeRemovable, _data,
			    _reply, 0);
		    _reply.readException();
		    _result = 0 != _reply.readInt();
		} finally {
	...
	// BEGIN MOT GB UPMERGE, A22569, 12/30/2010
	static final int TRANSACTION_getPlayNotificationSounds = IBinder.FIRST_CALL_TRANSACTION + 25;

	static final int TRANSACTION_setPlayNotificationSounds = IBinder.FIRST_CALL_TRANSACTION + 26;

	static final int TRANSACTION_getVolumeList = IBinder.FIRST_CALL_TRANSACTION + 27;

	static final int TRANSACTION_unmountVolumeForUSBFlashDrive = IBinder.FIRST_CALL_TRANSACTION + 28;

	static final int TRANSACTION_mountUSBDiskIfAny = IBinder.FIRST_CALL_TRANSACTION + 29;
	// END MOT GB UPMERGE
	// BEGIN Motorola, a18273, IKHALFMWK-363
	static final int TRANSACTION_getSecureContainerVolume = IBinder.FIRST_CALL_TRANSACTION + 30;

	static final int TRANSACTION_isVolumeRemovable = IBinder.FIRST_CALL_TRANSACTION + 31;
	// END IKHALFMWK-363

	/** BEGIN Motorola, Ken Chen/e50324, 01/18/2011, IKMAIN-15352 */
	static final int TRANSACTION_validateVolume = IBinder.FIRST_CALL_TRANSACTION + 32;
	...
	public boolean onTransact(int code, Parcel data, Parcel reply, int flags)
		...
		int resultCode = createSecureContainer(id, sizeMb, fstype, key,
			ownerUid);
		reply.writeNoException();
		reply.writeInt(resultCode);
		return true;
		...
		data.enforceInterface(DESCRIPTOR);
		boolean status = getPlayNotificationSounds();
		reply.writeNoException();
		reply.writeInt((status ? 1 : 0));
		return true;
	    }
		...
		data.enforceInterface(DESCRIPTOR);
		boolean enabled = 0 != data.readInt();
		setPlayNotificationSounds(enabled);
		reply.writeNoException();
		return true;
	    }
	    case TRANSACTION_getVolumeList: {
		data.enforceInterface(DESCRIPTOR);
		String[] paths = getVolumeList();
		reply.writeNoException();
		reply.writeStringArray(paths);
		return true;
	    }
	    case TRANSACTION_unmountVolumeForUSBFlashDrive: {
		data.enforceInterface(DESCRIPTOR);
		String mountPoint = data.readString();
		boolean force = 0 != data.readInt();
		unmountVolumeForUSBFlashDrive(mountPoint, force);
		reply.writeNoException();
		return true;
	    }
	    case TRANSACTION_mountUSBDiskIfAny: {
		data.enforceInterface(DESCRIPTOR);
		mountUSBDiskIfAny();
		reply.writeNoException();
		return true;
	    ...
	    // END MOT GB UPMERGE
	    // BEGIN Motorola, a18273, IKHALFMWK-363
	    case TRANSACTION_getSecureContainerVolume: {
		data.enforceInterface(DESCRIPTOR);
		String path = getSecureContainerVolume();
		reply.writeNoException();
		reply.writeString(path);
		return true;
	    }
	    case TRANSACTION_isVolumeRemovable: {
		data.enforceInterface(DESCRIPTOR);
		String mountPoint = data.readString();
		boolean removable = isVolumeRemovable(mountPoint);
		reply.writeNoException();
		reply.writeInt((removable ? 1 : 0));
		return true;
	    }
	    // END IKHALFMWK-363
	    /** BEGIN Motorola, Ken Chen/e50324, 01/18/2011, IKMAIN-15352 */
	    case TRANSACTION_validateVolume: {
		data.enforceInterface(DESCRIPTOR);
		String mountPoint;
		mountPoint = data.readString();
		String dkey;
		dkey = data.readString();
		boolean sync;
		sync = 0 != data.readInt();
		int resultCode = validateVolume(mountPoint, dkey, sync);
		reply.writeNoException();
		reply.writeInt(resultCode);
		return true;
	    }
    ...
    public int createSecureContainer(String id, int sizeMb, String fstype,
	    String key, int ownerUid) throws RemoteException;
    ...
    /** BEGIN Motorola, Ken Chen/e50324, 01/18/2011, IKMAIN-15352 */
    /**
     * Validate external storage at given mount point with given derived key
     */
    int validateVolume(String mountPoint, String dkey, boolean sync)
	    throws RemoteException;
    ...
    // BEGIN MOT GB UPMERGE, A22569, 12/30/2010
    // BEGIN Motorola, a23221, 07/30/2010, IKSTABLETWO-768
    /**
     * Returns true if media notification sounds are enabled.
     */
    boolean getPlayNotificationSounds() throws RemoteException;

    /**
     * Sets whether or not media notification sounds are played.
     */
    void setPlayNotificationSounds(boolean value) throws RemoteException;

    // END IKSTABLETWO-768

    // BEGIN Motorola, a18273, 11/8/2010, IKHALFMWK-63
    /**
     * get supported volume list, /mnt/sdcard, /mnt/sdcard-ext
     */
    String[] getVolumeList() throws RemoteException;

    // END IKHALFMWK-63

    // BEGIN Motorola, gkr634, 12/20/2010, IKHALFMWK-170
    // add an api for unmounting USB flash drive
    void unmountVolumeForUSBFlashDrive(String mountPoint, boolean force)
	    throws RemoteException;

    // add an api for mounting USB disk
    void mountUSBDiskIfAny() throws RemoteException;
    ...
    // return volume which has secure container(where external app been
    // installed)
    String getSecureContainerVolume() throws RemoteException;

    // return if a given mount point mapping to removable storage
    boolean isVolumeRemovable(String mountPoint) throws RemoteException;
    // END IKHALFMWK-363
