...
public class ActionBar extends LinearLayout {
    ...
    public ActionBar(Context context, AttributeSet attrs) {
        ...
        if (a != null) {
            mPosition = a.getInt(R.styleable.ActionBar_position, 0);
            // if position is not right or bottom, default it to bottom
            if (mPosition != ACTIONBAR_RIGHT && mPosition != ACTIONBAR_BOTTOM) {
    ...
    public void setPosition(int pos) {
        if(pos != ActionBar.ACTIONBAR_BOTTOM && pos != ActionBar.ACTIONBAR_RIGHT)
