...
/*2012-11-05, DJHV83 merged from Ironprime_TD*/
import com.motorola.providers.contacts.MotContactsDatabaseHelper;
...
public class ContactsDatabaseHelper extends SQLiteOpenHelper {
    ...
    /*2012-11-05, DJHV83 merged from Ironprime_TD*/
    private static final String ACCOUNT_TYPE_CARD = "com.card.contacts";
    /*DJHV83 End*/
    ...
    public interface Views {
        ...
        public static final String STREAM_ITEMS_ALL = "view_stream_items";
        public static final String STREAM_ITEMS_RESTRICTED = "view_stream_items_restricted";
    ...
    public interface Clauses {
        ...
        final String CONTACT_IS_VISIBLE =
                ...
                " WHERE " + RawContactsColumns.CONCRETE_ID + "=" + OUTER_RAW_CONTACTS_ID + ")),0)" +
    ...
    public interface ContactsColumns {
        /*2012-11-05, DJHV83 merged from Ironprime_TD*/
        public static final String SINGLE_IS_RESTRICTED = "single_is_restricted"; //MOT MOD - IKPIM-955
        /*DJHV83 End*/
    ...
    public interface ViewRawContactsColumns {
        String CONCRETE_ACCOUNT_NAME = Views.RAW_CONTACTS_ALL + "." + RawContacts.ACCOUNT_NAME;
        String CONCRETE_ACCOUNT_TYPE = Views.RAW_CONTACTS_ALL + "." + RawContacts.ACCOUNT_TYPE;
        String CONCRETE_DATA_SET = Views.RAW_CONTACTS_ALL + "." + RawContacts.DATA_SET;
    }
    ...
    public interface ViewGroupsColumns {
        String CONCRETE_ACCOUNT_NAME = Views.GROUPS_ALL + "." + Groups.ACCOUNT_NAME;
        String CONCRETE_ACCOUNT_TYPE = Views.GROUPS_ALL + "." + Groups.ACCOUNT_TYPE;
        String CONCRETE_DATA_SET = Views.GROUPS_ALL + "." + Groups.DATA_SET;
    }
    ...
    */
    private String[] mUnrestrictedPackages;  //MOT MOD - IKPIM-955

    /**
    * List of moto signed package names with access to {@link RawContacts#IS_RESTRICTED} data.
    */
    private String[] mUnrestrictedMotSignedPackages; //MOT MOD - IKPIM-955
    /*DJHV83 End*/
    ...
    /*2012-11-05, DJHV83 merged from Ironprime_TD*/
    //MOT MOD BEGIN
    private MotContactsDatabaseHelper mMotDbHelper;

    public MotContactsDatabaseHelper getMotDbHelper() {
        return mMotDbHelper;
    }
    //MOT MOD END
    /*DJHV83 End*/
    ...
    protected ContactsDatabaseHelper(
        ...
        /*2012-11-05, DJHV83 merged from Ironprime_TD*/
        //MOT MOD BEGIN - IKHSS6UPGR-7347
        //mFID26391on = resources.getBoolean(R.bool.config_fid26391_on);
        //MOT MOD END

        //MOT MOD BEGIN
        mMotDbHelper = new MotContactsDatabaseHelper(context);
        //MOT MOD END
        ...
        resourceId = resources.getIdentifier("unrestricted_motosignature_packages",
            "array", context.getPackageName());
        if (resourceId != 0) {
            mUnrestrictedMotSignedPackages = resources.getStringArray(resourceId);
        } else {
            mUnrestrictedMotSignedPackages = new String[0];
        }
        //MOT MOD END - IKPIM-955     
        /*DJHV83 End*/
    }
    ...
    private void initializeCache(SQLiteDatabase db) {
        ...
        /*2012-11-05, DJHV83 merged from Ironprime_TD*/
        // MOT MOD BEGIN -- IKHSS7-39433
        // we pre-cache GroupMembership mimetype, so the group mimetype will
        // not be inserted when quering settings table.
        lookupMimeTypeId(GroupMembership.CONTENT_ITEM_TYPE, db);
        // MOT MOD END
        /*DJHV83 End*/
    }
    ...
    public void onOpen(SQLiteDatabase db) {
        ...
        /*2012-11-05, DJHV83 merged from Ironprime_TD*/
        //MOT MOD BEGIN
        mMotDbHelper.onOpen(this, mContext, db);
        //MOT MOD END
        /*DJHV83 End*/
    }
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE " + Tables.CONTACTS + " (" +
                ...
                ContactsColumns.SINGLE_IS_RESTRICTED + " INTEGER NOT NULL DEFAULT 0" +  //MOT MOD - IKPIM-955
                /*DJHV83 End*/
        ");");
        ...
        db.execSQL("CREATE TABLE " + Tables.RAW_CONTACTS + " (" +
                ...
                /*2012-11-05, DJHV83 merged from Ironprime_TD*/
                Constants.RawContacts_IS_RESTRICTED + " INTEGER DEFAULT 0," +  //MOT MOD - IKPIM-955
                /*DJHV83 End*/
...
//        ");");
        ...
        db.execSQL("CREATE TABLE " + Tables.CALLS + " (" +
                ...
                Calls.TYPE + " INTEGER," +
                /*2012-11-05, DJHV83 merged from Ironprime_TD*/
                CallLogProvider.NETWORK + " INTEGER," +
                CallLogProvider.SIMTYPE + " INTEGER," +
                /*DJHV83 End*/
                Calls.NEW + " INTEGER," +
        ...
        /*2012-11-05, DJHV83 merged from Ironprime_TD*/
        //MOT MOD BEGIN let MotContactsDatabaseHelper create its tables before creating triggers/indexes.
        mMotDbHelper.onCreate(mContext, db);
        //MOT MOD END
        /*DJHV83 End*/
    ...
    private void createContactsTriggers(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TRIGGER " + Tables.RAW_CONTACTS + "_deleted "
                ...
                + "     WHERE " + Data.RAW_CONTACT_ID
                                + "=OLD." + RawContacts._ID + ";"
                /*2012-11-05, DJHV83 merged from Ironprime_TD*/
                + "   DELETE FROM " + MotContactsDatabaseHelper.Tables.MOTO_EXTENSION_LOOKUP
                + "     WHERE " + MotContactsDatabaseHelper.MotoExtensionLookupColumns.RAW_CONTACT_ID
                                + "=OLD." + RawContacts._ID + ";"
                /*DJHV83 End*/
    ...
    /*2012-11-05, DJHV83 merged from Ironprime_TD*/
    public  void createContactsViews(SQLiteDatabase db) {  //MOT MOD - IKPIM-955 change it to public method
        //MOT MOD BEGIN - IKPIM-955
        ...
        db.execSQL("DROP VIEW IF EXISTS " + Views.STREAM_ITEMS_ALL + ";");
        db.execSQL("DROP VIEW IF EXISTS " + Views.STREAM_ITEMS_RESTRICTED + ";");
        //MOT MOD END - IKPIM-955
    /*DJHV83 End*/
        String dataColumns =
                Data.IS_PRIMARY + ", "
        ...
        db.execSQL("CREATE VIEW " + Views.DATA_RESTRICTED + " AS " + dataSelect + " WHERE "
                + Constants.RawContactsColumns_CONCRETE_IS_RESTRICTED + "=0");
        //MOT MOD END - IKPIM-955
        /*DJHV83 End*/
        ...
        db.execSQL("CREATE VIEW " + Views.RAW_CONTACTS_RESTRICTED + " AS " + rawContactsSelect
                + " WHERE " + Constants.RawContacts_IS_RESTRICTED + "=0");
        //MOT MOD END - IKPIM-955
        /*DJHV83 End*/
        ...
        String rawEntitiesSelect = "SELECT "
                ...
                /*2012-11-05, DJHV83 merged from Ironprime_TD*/
                + Tables.GROUPS + "." + Groups.SOURCE_ID + " AS " + GroupMembership.GROUP_SOURCE_ID + ","
                + Constants.RawContactsColumns_CONCRETE_IS_RESTRICTED + " AS " + Constants.RawContacts_IS_RESTRICTED    //MOT MOD - IKPIM-955
                /*DJHV83 End*/
                + " FROM " + Tables.RAW_CONTACTS
                + " JOIN " + Tables.ACCOUNTS + " ON ("
                +   RawContactsColumns.CONCRETE_ACCOUNT_ID + "=" + AccountsColumns.CONCRETE_ID
        ...
        db.execSQL("CREATE VIEW " + Views.RAW_ENTITIES_RESTRICTED + " AS "
                + rawEntitiesSelect + " WHERE " + Constants.RawContacts_IS_RESTRICTED + "=0");
        //MOT MOD END - IKPIM-955
        /*DJHV83 End*/
        ...
        String entitiesSelect = "SELECT "
                ...
                /*2012-11-05, DJHV83 merged from Ironprime_TD*/
                + Tables.GROUPS + "." + Groups.SOURCE_ID + " AS " + GroupMembership.GROUP_SOURCE_ID + ", "
                + Constants.RawContactsColumns_CONCRETE_IS_RESTRICTED    //MOT MOD - IKPIM-955
                        + " AS " + Constants.RawContacts_IS_RESTRICTED    //MOT MOD - IKPIM-955
                /*DJHV83 End*/   
                + " FROM " + Tables.RAW_CONTACTS
                + " JOIN " + Tables.ACCOUNTS + " ON ("
                +   RawContactsColumns.CONCRETE_ACCOUNT_ID + "=" + AccountsColumns.CONCRETE_ID
        ...
        db.execSQL("CREATE VIEW " + Views.ENTITIES_RESTRICTED + " AS "
                + entitiesSelect + " WHERE " + Constants.RawContactsColumns_CONCRETE_IS_RESTRICTED + "=0");
        //MOT MOD END - IKPIM-955
        /*DJHV83 End*/
        ...
        /*2012-11-05, DJHV83 merged from Ironprime_TD*/
        //MOT MOD BEGIN - IKPIM-955
        db.execSQL("CREATE VIEW " + Views.STREAM_ITEMS_ALL + " AS " + streamItemSelect);
        db.execSQL("CREATE VIEW " + Views.STREAM_ITEMS_RESTRICTED + " AS "
                + streamItemSelect + " WHERE "
                + Constants.RawContactsColumns_CONCRETE_IS_RESTRICTED + "=0");
        //MOT MOD END - IKPIM-955
        /*DJHV83 End*/
    }
    ...
    private void createGroupsView(SQLiteDatabase db) {
        /*2012-11-05, DJHV83 merged from Ironprime_TD*/
        db.execSQL("DROP VIEW IF EXISTS " + Views.GROUPS_ALL + ";"); //MOT MOD - IKPIM-955
        /*DJHV83 End*/
        ...
        /*2012-11-05, DJHV83 merged from Ironprime_TD*/
        db.execSQL("CREATE VIEW " + Views.GROUPS_ALL + " AS " + groupsSelect); //MOT MOD - IKPIM-955
        /*DJHV83 End*/
    }
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        /*2012-11-05, DJHV83 merged from Ironprime_TD*/
        int saved_oldVersion = oldVersion; //MOT MOD
        /*DJHV83 End*/
        if (oldVersion < 99) {
        ...
        /*2012-11-05, DJHV83 merged from Ironprime_TD*/
        //MOT MOD BEGIN
        mMotDbHelper.onUpgrade(this, mContext, db, saved_oldVersion, newVersion);
        //MOT MOD END
        /*DJHV83 End*/
    }
    ...
    /*2012-11-05, DJHV83 merged from Ironprime_TD*/
    private void upgradeToVersion625(SQLiteDatabase db) {
        AccountManager am = AccountManager.get(mContext);
	Log.v(TAG, "upgradeToVersion625(), am = "+am);
        if (am != null) {
	     Account[] accounts_card = am.getAccountsByType(ACCOUNT_TYPE_CARD);
             // remove old card accounts in DB, and re-generate new structure card accounts
	     if (accounts_card != null &&  accounts_card.length > 0) {
	         for (Account account : accounts_card) {
	              Log.v(TAG, "Removing account: "+account);
		      AccountManagerFuture<Boolean> blockingResult = am.removeAccount(account, null, null);
	         }
	     }
        }
    }
    ...
    private void appendPhoneLookupTables(StringBuilder sb, final String minMatch,
        ...
        if (joinContacts) {
            /*2012-11-05, DJHV83 merged from Ironprime_TD*/
            sb.append(" JOIN " + getContactView() + " contacts_view"//MOT MOD - IKPIM-955
            /*DJHV83 End*/
...
/*
        //MOTO MOD BEGIN - IKPIM-432
        //check the signature and package name to
        //determine if requestingPackage should be allowed access restricted contacts
        if (mUnrestrictedMotSignedPackages != null) {
            for (String allowedPackage : mUnrestrictedMotSignedPackages) {
                if (allowedPackage.equals(requestingPackage)) {
                    if (MotoSignature.getInstance().checkSignatureByPackage(
                           mContext, requestingPackage)) {
                        return true;
                    }
                }
            }
...
*/
    ...
    public String getDataUsageStatView(boolean requireRestrictedView) {
      ...
      public String getStreamItemsView() {
        return getStreamItemsView(false);
    }

      public String getStreamItemsView(boolean requireRestrictedView) {
        return (hasAccessToRestrictedData() && !requireRestrictedView) ?
                Views.STREAM_ITEMS_ALL : Views.STREAM_ITEMS_RESTRICTED;
    }
    //MOT MOD END - IKPIM-955
    /*DJHV83 End*/
    ...
    /*2012-11-05, DJHV83 merged from Ironprime_TD*/
    // 2012.09.13 jrw647 added to fix cr SWITCHUITWOV-180
    private int getNameStyle(String givenName, String middleName,
            String familyName) {
        if(givenName != null && givenName.getBytes().length != givenName.length()
                || middleName != null && middleName.getBytes().length != middleName.length()
                || familyName != null && familyName.getBytes().length != familyName.length()){
    ...
    public void updateRawContactDisplayName(SQLiteDatabase db, long rawContactId) {
        ...
        try {
            while (c.moveToNext()) {
                ...
                if (mimeType == getMimeTypeIdForStructuredName()) {
                    ...
                    /*2012-11-05, DJHV83 merged from Ironprime_TD*/
                    // 2012.08.29 jrw647 modified to fix cr IKCBSMMCPPRC-1767, SWITCHUITWOV-180
                    /*2013-1-15, add by amt_sunzhao for SWITCHUITWO-342 */ 
                    /*
                     * when insert table[data], we had call insert of DataRowHandlerForStructuredName in insertData 
                     * to invoke fixStructuredNameComponents of DataRowHandlerForStructuredName to retrieve the
                     * right full name style.
                     */
                    ...
                    //name.fullNameStyle = getNameStyle(name.givenNames, name.middleName, name.familyName);
                    /*2013-1-15, add end*/ 
                    /*DJHV83 End*/
        ...
        if (bestDisplayNameSource == DisplayNameSources.STRUCTURED_NAME) {
            ...
            /*2012-11-05, DJHV83 merged from Ironprime_TD*/
            // 2012.09.20 jrw647 added to fix SWITCHUITWOV-201 to ignore the middle name synced from email server
            bestName.middleName = "";
            /*DJHV83 End*/
            ...
            if (displayNameStyle == FullNameStyle.CHINESE ||
                ...
                sortKeyPrimary = sortKeyAlternative =
                        ContactLocaleUtils.getIntance().getSortKey(
                        		bestPhoneticName, displayNameStyle);
            }
            /*DJHV83 End*/
        } else {
