...
public class ContactAggregator {
    ...
    private interface RawContactsQuery {
        String SQL_FORMAT =
                "SELECT "
                        ...
                        + Photo.PHOTO_FILE_ID + ","
                        + Constants.RawContacts_IS_RESTRICTED +  //MOT MOD - IKPIM-955
                " FROM " + Tables.RAW_CONTACTS +
        ...
        int IS_RESTRICTED = 17;  //MOT MOD - IKPIM-955
    }
    ...
    private interface ContactReplaceSqlStatement {
        String UPDATE_SQL =
                ...
                " SET "
                        ...
                        + Contacts.LOOKUP_KEY + "=?, "
                        + ContactsColumns.SINGLE_IS_RESTRICTED + "=? " + //MOT MOD - IKPIM-955
                " WHERE " + Contacts._ID + "=?";
        ...
        int LOOKUP_KEY = 10;
        int SINGLE_IS_RESTRICTED = 11;  //MOT MOD - IKPIM-955
        int CONTACT_ID = 12;
    }
    ...
    private void computeAggregateData(final SQLiteDatabase db, String sql, String[] sqlArgs,
        ...
        int singleIsRestricted = 1; //MOT MOD - IKPIM-955
...
/* NWQ834 End */
    ...
    public void updateDisplayNameForContact(SQLiteDatabase db, long contactId) {
        ...
        mSelectionArgs1[0] = String.valueOf(contactId);
        final Cursor c = db.query(Views.RAW_CONTACTS_ALL, DisplayNameQuery.COLUMNS,
                RawContacts.CONTACT_ID + "=?", mSelectionArgs1, null, null, null);
        try {
            while (c.moveToNext()) {
    ...
    private interface LookupKeyQuery {
        String TABLE = Views.RAW_CONTACTS_ALL;
        String[] COLUMNS = new String[] {
            RawContacts._ID,
            RawContactsColumns.DISPLAY_NAME,
            RawContacts.ACCOUNT_TYPE_AND_DATA_SET,
