...
public class NameNormalizer {
    ...
    static {
        // MOTO MOD BEGIN, PIM-Contacts, gfj763, IKHSS6UPGR-1068, IKHSS6UPGR-1502
        String sLocale = Locale.getDefault().toString();
        if (sLocale.equals("tr_TR") || sLocale.equals("el_GR")) {
            sCompressingCollator = (RuleBasedCollator)Collator.getInstance(Locale.US);
        } else {
            sCompressingCollator = (RuleBasedCollator)Collator.getInstance(Locale.CHINA);
        }
        // MOTO MOD END, PIM-Contacts, gfj763, IKHSS6UPGR-1068
    ...
    static {
        ...
        String sLocale = Locale.getDefault().toString();
        if (sLocale.equals("tr_TR") || sLocale.equals("el_GR")) {
            sComplexityCollator = (RuleBasedCollator)Collator.getInstance(Locale.US);
        } else {
            sComplexityCollator = (RuleBasedCollator)Collator.getInstance(Locale.CHINA);
        }
        // MOTO MOD END, PIM-Contacts, gfj763, IKHSS6UPGR-1068
