...
/* 2012-11-05, NWQ834 merged from Ironprime_TD */
            // 2012.10.24 jrw647 added to fix SWITCHUITWOV-283
...
/* 2012-11-05, NWQ834 merged from Ironprime_TD */
            // 2012.10.23 to fix SWITCHUITWOV-277 to remove the middle name by bphx43
            if(name.middleName != null){
            	name.givenNames = name.givenNames+" "+name.middleName;
...
/* 2012-11-05, NWQ834 merged from Ironprime_TD */
        ...
        if(name.middleName != null){
            name.givenNames = name.middleName + name.givenNames;
            name.middleName = null;
        }
/* NWQ834 End */
