...
public class VoicemailPermissions {
    ...
    /**
     *  Moto - BEGIN - IKPIM-964
     *
     *  If calling proceess has "com.motorola.voicemail.permission.READ_WRITE_ALL_VOICEMAIL"
     *  permission, grants access to all voicemails.
     *  This permission is currently defined in Dynamic Shortcut project in Home app,
     *  used in Motorola special cases, and in the future should be moved to another app which
     *  can represent Contact component and also be signed with Common key.
     */
    ...
    public boolean callerHasFullAccess() {
        return callerHasPermission(android.Manifest.permission.ADD_VOICEMAIL) &&
                (callerHasPermission(Manifest.permission.READ_WRITE_ALL_VOICEMAIL) ||
                 callerHasPermission("com.motorola.voicemail.permission.READ_WRITE_ALL_VOICEMAIL"));
/* NWQ834 End */
    }
    /**
     *  Moto - END - IKPIM-964
