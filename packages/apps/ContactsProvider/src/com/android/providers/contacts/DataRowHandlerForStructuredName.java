...
public class DataRowHandlerForStructuredName extends DataRowHandler {
    ...
    public long insert(SQLiteDatabase db, TransactionContext txContext, long rawContactId,
        ...
        //MOT MOD BEGIN smartdialer feature
        mDbHelper.getMotDbHelper().insertNameLookupTokenForSmartDialer(db, rawContactId, name, values);
        //MOT MOD END
    ...
    public boolean update(SQLiteDatabase db, TransactionContext txContext, ContentValues values,
        ...
        if (values.containsKey(StructuredName.DISPLAY_NAME) ||
            ...
            //MOT MOD BEGIN smartdialer feature
            mDbHelper.getMotDbHelper().deleteNameLookupTokenForSmartDialer(db, rawContactId);
            //MOT MOD END
