...
public class APRPreferences {
	...
	static String APR_PREFS_FLEX_INIT     = "APRPrefsFlexInit";
    ...
    static String APR_PREFS_DURATION_VALUE         = "APRPrefsDurationValue";
    static String APR_PREFS_READ_FLEX_SUCCESS      = "APRPrefsReadFlexSuccess";
   ...
   static CARRIER default_carrier              = CARRIER.CHINA_UMTS;
   ...
   static String APR_DURATIONVALUE = "12";
   ...
   public static boolean APRServiceResetPhoneInfo()
   {
	...
	{
		return APRSharedPrefs.getBoolean( APR_PREFS_ENABLED_STATE, false );
	}
	...
	public static boolean APRSetDurationValue( String duration ){
		boolean return_result = false;
		...
		prefs_editor.putString( APR_PREFS_DURATION_VALUE, duration );
	...
	public static String APRGetDurationValue() {

		APRSharedPrefs = mContext.getSharedPreferences( APR_PREFS_NAME, android.content.Context.MODE_PRIVATE);

		String duration_value = APRSharedPrefs.getString( APR_PREFS_DURATION_VALUE, APR_DURATIONVALUE );

		return( duration_value);
	}

	public static void APRSetReadFlexSuccess( boolean read_flex_success) {
		APRSharedPrefs = mContext.getSharedPreferences( APR_PREFS_NAME, android.content.Context.MODE_PRIVATE);

		Editor prefs_editor = APRSharedPrefs.edit();

		prefs_editor.putBoolean( APR_PREFS_READ_FLEX_SUCCESS, read_flex_success );

		prefs_editor.commit();
	}
	
	public static boolean APRGetReadFlexSuccess() {
		APRSharedPrefs = mContext.getSharedPreferences( APR_PREFS_NAME, android.content.Context.MODE_PRIVATE);

		return (APRSharedPrefs.getBoolean( APR_PREFS_READ_FLEX_SUCCESS, false ));
	}
	
	public static boolean APRPrefsGetFlexInit() {
		
		return( APRSharedPrefs.getBoolean( APR_PREFS_FLEX_INIT, false ) );
	}
	
	public static void APRPrefsSetFlexInit( boolean flex_init )
	{
		Editor prefs_editor = APRSharedPrefs.edit();
		
		// Put this at the end of our preferences.
		prefs_editor.putBoolean( APR_PREFS_FLEX_INIT, flex_init );
