...
public class APRScanFileBPPanicDefault {
	
	static String TAG = "APRScanFileBPPanicDefault";

	static private byte[] raw_data = null;
	
	APRScanFileBPPanicDefault( byte[] crash_log )
	{
	...
	public int GetPanicID()
	{
		...
		return( PANIC_ID.MODEM_CRASH.id );
	}
