...
public class APRScanFileBPCDMA extends APRScanFileBPPanicDefault {

	static String TAG = "APRScanFileBPCDMA";
	...
	// Begin Version 1.0
	static boolean VERSION_1_REVERSE_BYTES = true;
	...
	APRScanFileBPCDMA(byte[] crash_log) {
		super(crash_log);
		
		version_number = GetVersionNumber();
		
		APRDebug.APRLog(TAG, "CDMA Panic File Version:" + version_number );
	}
