...
public class DefaultContactListAdapter extends ContactListAdapter implements OnScrollListener ,com.motorola.contacts.widget.ListAccelerator.Interface{
//MOTO MOD END
    ...
    protected void bindView(View itemView, int partition, Cursor cursor, int position) {
        ...
        if (isCheckBoxEnabled()) {
            ...
            if (PhoneCapabilityTester.isUsingTwoPanes(this.mContext)==false) {
...
//MOTO MOD BEGIN,implemnts the interface for Accelerator
    ...
    public int getVisibleOffset(){
        return mInterface != null ? mInterface.getVisibleOffset() : 0;
    }
