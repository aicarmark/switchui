...
public class PhoneFavoriteFragment extends Fragment implements OnItemClickListener {
    ...
    private class ContactTileLoaderListener implements LoaderManager.LoaderCallbacks<Cursor> {
        ...
        public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
            ...
            //MOTO MOD BEGIN
            mContactTileAdapter.notifyDataSetInvalidated();
    ...
    private class AllContactsLoaderListener implements LoaderManager.LoaderCallbacks<Cursor> {
        boolean isContactsSearchEnabled = false; //MOT Dialer Code - IKHSS6UPGR-7991
        ...
        public Loader<Cursor> onCreateLoader(int id, Bundle args) {
            ...
            isContactsSearchEnabled = getActivity().getResources().//MOT Dialer Code - IKHSS6UPGR-7991
                                         getBoolean(R.bool.config_enable_contacts_search_in_phone);
            if (isContactsSearchEnabled) {
                //in order to not show all contacts list in favorite fragment,
                //set invalid parameter to get empty result.
                loader.setSelection("1" + "=?");
        ...
        public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
            ...
            //MOT Dialer Code Start - IKHSS6UPGR-7991
            if (isContactsSearchEnabled) {
                //As we do not show contacts list, also hide the header here
    ...
    public void onDestroyView() {
        super.onDestroyView();
        getLoaderManager().destroyLoader(LOADER_ID_ALL_CONTACTS);
        getLoaderManager().destroyLoader(LOADER_ID_CONTACT_TILE);
        Cursor c = mContactTileAdapter.getContactCursor();
