    ...
    public void bindView(boolean dropdown) {
        ...
        switch (mFilter.filterType) {
            ...
            case ContactListFilter.FILTER_TYPE_ACCOUNT: {
                ...
                if (HardCodedSources.ACCOUNT_LOCAL_DEVICE.equals(mFilter.accountName)) {
                    mLabel.setText(R.string.account_local_device);
                } else if (HardCodedSources.ACCOUNT_CARD_C.equals(mFilter.accountName)) {
                    mLabel.setText(R.string.account_card_C);
                } else if (HardCodedSources.ACCOUNT_CARD_G.equals(mFilter.accountName)) {
                    mLabel.setText(R.string.account_card_G);
                } else if (HardCodedSources.ACCOUNT_CARD.equals(mFilter.accountName)) {
                    final int phoneType = SimUtility.getTypeByAccountName(mFilter.accountName);
                    if (phoneType == TelephonyManager.PHONE_TYPE_CDMA) {
                        mLabel.setText(R.string.account_card_uim);
                    } else {
                        mLabel.setText(R.string.account_card_G);
                    }
                } else {
