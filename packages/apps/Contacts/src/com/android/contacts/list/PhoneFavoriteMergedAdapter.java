...
public class PhoneFavoriteMergedAdapter extends BaseAdapter implements SectionIndexer {
    ...
    public PhoneFavoriteMergedAdapter(Context context,
        ...
        mItemPaddingLeft = 0/*resources.getDimensionPixelSize(R.dimen.detail_item_side_margin)*/;   //MOTO Dialer Code IKHSS6-865
...
//MOTO MOD END
    public void unregister(){
        if(mContactTileAdapter != null && mObserver != null){
            mContactTileAdapter.unregisterDataSetObserver(mObserver);
        }
        if(mContactEntryListAdapter != null && mObserver != null){
            mContactEntryListAdapter.unregisterDataSetObserver(mObserver);
        }
        mObserver = null;
    }
    public void register(){
        if(mObserver == null ){
            ...
            if(mContactEntryListAdapter != null){
                mContactEntryListAdapter.unregisterDataSetObserver(mObserver);
            }
        }
        if(mObserver != null){
