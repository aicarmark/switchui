            ...
            if (mPhotoManager != null) {
                if (mPhoto != null) {
                    if (entry.photoUri != null) {
                        ...
                        mPhotoManager.loadDefaultPhoto(mPhoto, entry.lookupKey, isDefaultIconHires(),
                                isDarkTheme());
                    }
                    ...
                    if (entry.photoUri != null) {
                        ...
                        mPhotoManager.loadDefaultPhoto(mQuickContact, entry.lookupKey, isDefaultIconHires(),
                                isDarkTheme());
                    }
                }
            } else {
