        ...
        LoaderCallbacks<CustomContactListFilterActivity.AccountSet>
{
    ...
    public static class CustomFilterConfigurationLoader extends AsyncTaskLoader<AccountSet> {
        ...
        public AccountSet loadInBackground() {
            CustomContactListFilterActivity target = (CustomContactListFilterActivity)mContext;
            ...
            for (AccountWithDataSet account : accountTypes.getAccounts(false)) {
                ...
                EntityIterator iterator = ContactsContract.Groups.newEntityIterator(resolver.query(
                        groupsUri.build(), null, Groups.DELETED + "=0", null, null));
                try {
    ...
    protected static class DisplayAdapter extends BaseExpandableListAdapter {
        ...
        public View getGroupView(int groupPosition, boolean isExpanded, View convertView,
            ...
            if (HardCodedSources.ACCOUNT_LOCAL_DEVICE.equals(account.mName)) {
                text1.setText(R.string.account_local_device);
            } else if (HardCodedSources.ACCOUNT_CARD_C.equals(account.mName)) {
                text1.setText(R.string.account_card_C);
            } else if (HardCodedSources.ACCOUNT_CARD_G.equals(account.mName)) {
                text1.setText(R.string.account_card_G);
            } else if (HardCodedSources.ACCOUNT_CARD.equals(account.mName)) {
                final int phoneType = SimUtility.getTypeByAccountName(account.mName);
                if (phoneType == TelephonyManager.PHONE_TYPE_CDMA) {
                    text1.setText(R.string.account_card_uim);
                } else {
                    text1.setText(R.string.account_card_G);
                }
            } else {
