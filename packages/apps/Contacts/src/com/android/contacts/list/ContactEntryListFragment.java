...
//<!-- MOTOROLA MOD Start: IKPIM-491 -->
    private static final String KEY_CHECKBOX_ENABLED = "checkBoxEnabled";
...
//<!-- MOTOROLA MOD Start: IKPIM-491 -->
        outState.putBoolean(KEY_CHECKBOX_ENABLED, mCheckBoxEnabled);
//<!-- MOTOROLA MOD End of IKPIM-491 -->
    ...
    public void onCreate(Bundle savedState) {
        ...
        mDarkTheme = getContext().getResources().getBoolean(R.bool.contacts_dark_ui);
...
//<!-- MOTOROLA MOD Start: IKPIM-491 -->
        mCheckBoxEnabled = savedState.getBoolean(KEY_CHECKBOX_ENABLED);
//<!-- MOTOROLA MOD End of IKPIM-491 -->
...
//<!-- MOTOROLA MOD Start: IKPIM-491 -->
    public void setCheckBoxEnabled(boolean flag) {
        this.mCheckBoxEnabled = flag;
    }
...
//<!-- MOTOROLA MOD End of IKPIM-491 -->
    ...
    //MOT MOD BEGIN - IKHSS7-2028
    public void setForExportOnly(boolean flag) {
        mForExportOnly = flag;
    }
    //MOT MOD END - IKHSS7-2028
    ...
    public void setQueryString(String queryString, boolean delaySelection) {
        ...
        if (!TextUtils.equals(mQueryString, queryString)) {
            ...
            /*Added for switchuitwo-484 begin*/
            if(mListView != null) {
            	mListView.setFastScrollEnabled(!TextUtils.isEmpty(mQueryString));
            }
            /*Added for switchuitwo-484 end*/
            if (mAdapter != null) {
    ...
    protected void configurePhotoLoader() {
        if (isPhotoLoaderEnabled() && mContext != null) {
            ...
            if (mListView != null) {
//MOTO MOD BEGIN
                if(mListView.getParent() != null && mListView.getParent() instanceof com.motorola.contacts.widget.ListAccelerator){
                    com.motorola.contacts.widget.ListAccelerator lisa = (com.motorola.contacts.widget.ListAccelerator)mListView.getParent();
                    lisa.setOnScrollListener(this);
                }else{
...
//<!-- MOTOROLA MOD Start: IKPIM-491 -->
        mAdapter.setCheckBoxEnabled(mCheckBoxEnabled);
//<!-- MOTOROLA MOD End of IKPIM-491 -->
    }
...
//<!-- MOTOROLA MOD Start: IKPIM-491 -->
        completeFragmentSpecificActionsOnLoadingCompleted();
//<!-- MOTOROLA MOD End of IKPIM-491 -->
    }
