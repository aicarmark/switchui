...
//<!-- MOTOROLA MOD Start: IKPIM-491 -->
    /** Show all contacts and pick a set of them when clicking */
    public static final int ACTION_PICK_MULTIPLE_CONTACT = 65;
...
//<!-- MOTOROLA MOD Start: IKPIM-491 -->
    /** Show all phone numbers and pick a set of them when clicking */
    public static final int ACTION_PICK_MULTIPLE_PHONE = 95;;
//<!-- MOTOROLA MOD End of IKPIM-491 -->
...
//<!-- MOTOROLA MOD Start: IKPIM-491 -->
    /** Show all postal addresses and pick a set of them when clicking */
    public static final int ACTION_PICK_MULTIPLE_POSTAL = 104;
//<!-- MOTOROLA MOD End of IKPIM-491 -->
