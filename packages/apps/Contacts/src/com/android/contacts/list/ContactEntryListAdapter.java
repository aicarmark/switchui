...
public abstract class ContactEntryListAdapter extends IndexerListAdapter implements OnScrollListener, com.motorola.contacts.widget.ListAccelerator.Interface {
//MOTO MOD END
...
//<!-- MOTOROLA MOD End of IKPIM-491 -->
    ...
    public ContactEntryListAdapter(Context context) {
        ...
        mDarkTheme = context.getResources().getBoolean(R.bool.contacts_dark_ui);
    }
...
//        }
    ...
    protected void bindQuickContact(final ContactListItemView view, int partitionIndex,
        ...
        if (photoId != 0) {
            ...
            getPhotoLoader().loadDefaultPhoto(quickContact, contactId, false, mDarkTheme);
        }
    }
...
//MOTO MOD BEGIN,implemnts the interface for Accelerator
    ...
    public boolean isNeeded(){
        return mInterface != null ? mInterface.isNeeded() : true;
    }
    public int getTopOffset(){
        return mInterface != null ? mInterface.getTopOffset() : 0;
    }
    public int getVisibleOffset(){
        return mInterface != null ? mInterface.getVisibleOffset() : -1;
    }
    public void setListAcceleratorListener(com.motorola.contacts.widget.ListAccelerator.Interface l){
        mInterface = l;
    }
    private com.motorola.contacts.widget.ListAccelerator.Interface mInterface = null;
//MOTO MOD END
}
