...
public class ContactListItemView extends ViewGroup
        implements SelectionBoundsAdjuster,Checkable   //<!-- MOTOROLA MOD IKPIM-491 to add Checkable -->
{
...
//<!-- MOTOROLA MOD Start: IKPIM-491 -->
    private final int mCheckBoxMargin;
    private final int mCheckBoxSize;
//<!-- MOTOROLA MOD End of IKPIM-491 -->
    ...
    public static final PhotoPosition DEFAULT_PHOTO_POSITION = PhotoPosition.LEFT; // Moto IKHSS7-647, change photo place to left
...
//<!-- MOTOROLA MOD Start: IKPIM-491 -->
        mCheckBoxMargin = 0; //TODO: set checkbox margin
        mCheckBoxSize = 30; //TODO: set checkbox size
//<!-- MOTOROLA MOD End of IKPIM-491 -->
...
//<!-- MOTOROLA MOD Start: IKPIM-491 -->
        if (isVisible(mCheckBox)) {
            int iconWidth = mCheckBox.getMeasuredWidth();
            rightBound -= mCheckBoxMargin + iconWidth;
            mCheckBox.layout(
                    rightBound,
                    topBound,
...
//<!-- MOTOROLA MOD Start: IKPIM-491 -->
    /**
     * Sets the proper check box (show or not show)
     */
    public void showCheckBox(boolean bNeedShow) {
        if (bNeedShow == true) {
            if (mCheckBox == null) {
                mCheckBox = new CheckBox(mContext);
                mCheckBox.setClickable(false); //Contact List Item itself will handle user click
...
//<!-- MOTOROLA MOD End of IKPIM-491 -->
    ...
    public void showSnippet(Cursor cursor, int summarySnippetColumnIndex) {
        ...
        if (extras.getBoolean(ContactsContract.DEFERRED_SNIPPETING)) {
            ...
            snippet = ContactsContract.snippetize(
                columnContent == null ? null : columnContent.trim(),//MOT MOD - IKHSS6-1159, IKHSS6-4402
