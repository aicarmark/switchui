...
public class EmailAddressListAdapter extends ContactEntryListAdapter {
    ...
    protected static class EmailQuery {
        ...
        public static final int EMAIL_CONTACT_ID   = 6; // MOT CHINA
    }

    private final CharSequence mUnknownNameText;
    private boolean mDarkTheme = false; //Moto Mod IKHSS6-4499, Config the dare theme by xml
    ...
    protected void bindPhoto(final ContactListItemView view, Cursor cursor) {
        ...
        //Moto Mod IKHSS6-4499, Config the dare theme by xml
        getPhotoLoader().loadPhoto(view.getPhotoView(), photoId, false, mDarkTheme);
        if (photoId != 0) {
            getPhotoLoader().loadPhoto(view.getPhotoView(), photoId, false, mDarkTheme);
        } else {
            long contactId = cursor.getLong(EmailQuery.EMAIL_CONTACT_ID);
            getPhotoLoader().loadDefaultPhoto(view.getPhotoView(), contactId, false, mDarkTheme);
        }        
    }
//
