...
public class FormatUtils {
    ...
    public static int indexOfWordPrefix(CharSequence text, char[] prefix) {
        ...
        while (i < textLength) {
            ...
            // BEGIN Motorola, ODC_001639, 2012-12-23, SWITCHUITWO-387 
            // Because the the Chinese word is continuous, the following steps is incorrect. 
            // The name of this function may need to be changed.
            // At the same time,such as "cott" will match "scott",it will highlight "cott" in "scott",but we can't search "scott" by "cott", so this situation will never happen
