...
/**
 * A very basic authenticator service for Local contacts.  At the moment, it has no UI hooks.  When called
...
public class LocalAuthenticatorService extends Service {
    ...
    class LocalAuthenticator extends AbstractAccountAuthenticator {
        public LocalAuthenticator(Context context) {
            super(context);
        }
        ...
        public Bundle addAccount(AccountAuthenticatorResponse response, String accountType,
            ...
            if (options != null && options.containsKey(OPTIONS_PASSWORD)
                ...
                AccountManager.get(LocalAuthenticatorService.this).addAccountExplicitly(
    ...
    public IBinder onBind(Intent intent) {
        ...
        if (authenticatorIntent.equals(intent.getAction())) {
            return new LocalAuthenticator(this).getIBinder();
        } else {
            return null;
        }
    }
