...
public class PhoneCallDetails {
    ...
    /** The CNAP name of the call. */
    public final String cnapName;

    /** Create the details for a call with a number not associated with a contact. */
    public PhoneCallDetails(CharSequence number, CharSequence formattedNumber,
            String countryIso, String geocode, int[] callTypes, int[] networkTypes, long date, long duration) {
        this(number, formattedNumber, countryIso, geocode, callTypes, networkTypes, date, duration, "", 0, "",
                null, null);
    }
    ...
    /** Create the details for a call with a number not associated with a contact. */
    public PhoneCallDetails(CharSequence number, CharSequence formattedNumber,
            String countryIso, String geocode, int[] callTypes, int[] networkTypes, long date, long duration, String cnapName) {
        this(number, formattedNumber, countryIso, geocode, callTypes, networkTypes, date, duration, "", 0, "",
                null, null, cnapName);
    }
}
