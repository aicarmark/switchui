...
public class PhoneNumberInteraction implements OnLoadCompleteListener<Cursor> {
    ...
    public static class PhoneDisambiguationDialogFragment extends DialogFragment
        ...
        private static final String ARG_ME_DIAL_FROM = "meDialFrom"; //MOTO Dialer Code IKHSS6-723

        private InteractionType mInteractionType;
        private ListAdapter mPhonesAdapter;
        private List<PhoneItem> mPhoneList;
        private String mCallOrigin;
        private MEDialer.DialFrom mDialFrom; //MOTO Dialer Code IKHSS6-723

        public static void show(FragmentManager fragmentManager,
                ArrayList<PhoneItem> phoneList, InteractionType interactionType,
                String callOrigin, MEDialer.DialFrom dialFrom) { //MOTO Dialer Code IKHSS6-723
            ...
            bundle.putInt(ARG_ME_DIAL_FROM, dialFrom.ordinal()); //MOTO Dialer Code IKHSS6-723
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            mDialFrom = MEDialer.DialFrom.values()[getArguments().getInt(ARG_ME_DIAL_FROM)]; //MOTO Dialer Code IKHSS6-723
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            if (mPhoneList.size() > which && which >= 0) {
                ...
                PhoneNumberInteraction.performAction(getActivity(), phoneItem.phoneNumber,
                        mInteractionType, mCallOrigin, mDialFrom); //MOTO Dialer Code IKHSS6-723
            } else {
                dialog.dismiss();
            }
        }
    ...
    private MEDialer.DialFrom mMEDialerFrom = MEDialer.DialFrom.UNKNOWN; //MOTO Dialer Code IKHSS6-723
    ...
    //MOTO Dialer Code IKHSS6-723 - Start
    //Construct for MEDialer feature to pass in dialFrom.
    private PhoneNumberInteraction(Context context, InteractionType interactionType,
            DialogInterface.OnDismissListener dismissListener, String callOrigin, MEDialer.DialFrom dialFrom) { //MOTO Dialer Code IKHSS6-723
        mContext = context;
        mInteractionType = interactionType;
        mDismissListener = dismissListener;
        mCallOrigin = callOrigin;
        mMEDialerFrom = dialFrom;
    }
     //MOTO Dialer Code IKHSS6-723 - End

    private void performAction(String phoneNumber) {
        PhoneNumberInteraction.performAction(mContext, phoneNumber, mInteractionType, mCallOrigin, mMEDialerFrom); //MOTO Dialer Code IKHSS6-723
    }
    ...
    private static void performAction(
        ...
        switch (interactionType) {
            case SMS:
                ...
                break;
            default:
                if (ContactsUtils.haveTwoCards(context)) {
                ...
                MEDialer.onDial(context, intent, dialFrom); //MOTO Dialer Code IKHSS6-723
                break;
        }
    ...
    //MOTO Dialer Code IKHSS6-723 - Start
    public static void startInteractionForPhoneCall(TransactionSafeActivity activity, Uri uri,
            String callOrigin, MEDialer.DialFrom dialFrom) {
        (new PhoneNumberInteraction(activity, InteractionType.PHONE_CALL, null, callOrigin, dialFrom))
                .startInteraction(uri);
    }
    //MOTO Dialer Code IKHSS6-723 - End
    ...
    /* package */ void showDisambiguationDialog(ArrayList<PhoneItem> phoneList) {
        PhoneDisambiguationDialogFragment.show(((Activity)mContext).getFragmentManager(),
                phoneList, mInteractionType, mCallOrigin, mMEDialerFrom); //MOTO Dialer Code IKHSS6-723
    }
}
