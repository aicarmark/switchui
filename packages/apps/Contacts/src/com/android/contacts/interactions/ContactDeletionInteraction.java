...
public class ContactDeletionInteraction extends Fragment
    ...
    private static final String[] ENTITY_PROJECTION = new String[] {
        ...
        Entity.CONTACT_ID, // 3
        Entity.LOOKUP_KEY, // 4
        Entity.ACCOUNT_NAME //5 // Motorola, ODC_001639, 2012-12-17, SWITCHUITWO-178
    };
    ...
    // Motorola, ODC_001639, 2012-12-17, SWITCHUITWO-178
    private static final int COLUMN_INDEX_ACCOUNT_NAME = 5;
    // END SWITCHUITWO-178
    ...
    static ContactDeletionInteraction startWithTestLoaderManager(
        ...
        if (ContactsUtils.contactIsCardType(activity, contactUri)) {
            if (!ContactsUtils.checkSimAvailable(activity, false)) {
                Log.v(FRAGMENT_TAG, "SIM card not available !");
                return null;
            }                           	
        }
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        // Motorola, ODC_001639, 2012-12-17, SWITCHUITWO-178
        HashSet<Account>  accountRawContacts = Sets.newHashSet();
        // END SWITCHUITWO-178
        ...
        while (cursor.moveToNext()) {
            ...
            // Motorola, ODC_001639, 2012-12-17, SWITCHUITWO-178
            final String accountName = cursor.getString(COLUMN_INDEX_ACCOUNT_NAME);
            accountRawContacts.add(new Account(accountName, accountType));
            // END SWITCHUITWO-178
        ...
        // Motorola, ODC_001639, 2012-12-17, SWITCHUITWO-178
        int accountCount = accountRawContacts.size();
        // END SWITCHUITWO-178
        ...
        } else if (readOnlyCount == 0 && writableCount > 1 && accountCount > 1) {// Motorola, ODC_001639, 2012-12-17, SWITCHUITWO-178
