...
//MOTO MOD BEGIN IKHSS7-1599 if the device supports SD-card, will export to SD-card only; if not supports SD-card, export to other storage
        File targetDirectory = StorageUtils.getSDCardDirectory(this);
        if(targetDirectory == null){
            targetDirectory = new File(getString(R.string.config_export_dir));
        }
//MOTO MOD END
        ...
        intent.setClass(this, VCardService.class);
