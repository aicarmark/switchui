...
//MOTO MODE BEGIN IKHSS7-1453
                          catch (java.lang.Exception e) {
                            Log.w(LOG_TAG, "Can't get a display name from the given Uri ", e);
                        }
//MOTO MODE END
                          finally {
                            if (cursor != null) {
...
//<!-- MOTOROLA MOD Start: IKPIM-491 -->
            } else if (ContactPreferenceUtilities.IfUserChoiceRemembered(this) && ContactPreferenceUtilities.GetUserPreferredAccountIndex(this, true)!=-1) {
                mAccount = ContactPreferenceUtilities.GetUserPreferredAccountFromSharedPreferences(this);
//<!-- MOTOROLA MOD End of IKPIM-491 -->
            } else {
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        //MOTO MODE BEGIN - IKTABLETMAIN-3534
        //finish();
        //MOTO MODE END
    }
...
//MOTO MOD BEGIN IKHSS7-1599 if the device supports SD-card, will export to SD-card only; if not supports SD-card, export to other storage
        File file = StorageUtils.getSDCardDirectory(this);
        if(file == null){
