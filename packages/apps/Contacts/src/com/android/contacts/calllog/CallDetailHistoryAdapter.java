...
public class CallDetailHistoryAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        NetworkTypeIconsView networkTypeIconView =
                (NetworkTypeIconsView) result.findViewById(R.id.network_type_icon);
        ...
        int[] networkTypes = details.networkTypes;
        networkTypeIconView.clear();
        if (networkTypes != null && networkTypes.length > 0) {
            int networkType = details.networkTypes[0];
            networkTypeIconView.clear();
            networkTypeIconView.add(networkType);
        }
        ...
        // Set the duration
        final String carrier = ContactsUtils.getCarrierName(mContext);
        boolean isCmccPhone = ContactsUtils.Carrier_CMCC.equals(carrier);
        if (callType == Calls.MISSED_TYPE || callType == Calls.VOICEMAIL_TYPE
                        || mContext.getResources().getBoolean(R.bool.ftr_35631_sprint_feature)
                        || isCmccPhone) {//FID 35631 Oct-17-2011, IKMAIN-29869
    ...
    private String formatDuration(long elapsedSeconds) {
        ...
        //mot calling code - IKSTABLE6-57
        String mins = mContext.getResources().getQuantityString(R.plurals.mins, (int)minutes);
        String secs = mContext.getResources().getQuantityString(R.plurals.secs, (int)seconds);
        return mContext.getString(R.string.callDetailsDurationFormat, minutes, mins, seconds, secs);
        //end mot calling code
    }
}
