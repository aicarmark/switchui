...
public final class CallLogQuery {
      private static final String CNAP_NAME = "cnap_name"; //IKMAIN-10554, a19591, 34425 Calling Name Presentation
    ...
    public static final String[] _PROJECTION = new String[] {
            ...
            Calls.IS_READ,                   // 16
            CACHED_CONVERT_NUMBER, //MOT Calling code - IKDROIDPRO-283//Mot add weikai //17
            CNAP_NAME,  //IKMAIN-10554, a19591, 34425 CNAP feature //18
            ContactsUtils.CallLog_NETWORK    //19
    };
    ...
    public static final int CALLER_CONVERT_NUM = 17;
    //IKMAIN-10554, a19591, 34425 begin
    public static final int CALLER_CNAPNAME = 18;
    /** The index of the synthetic "section" column in the extended projection. */
    public static final int NETWORK_TYPE_COLUMN_INDEX = 19;
