...
/*package*/ class CallLogListItemHelper {
    ...
    public void setPhoneCallDetails(CallLogListItemViews views, PhoneCallDetails details,
            boolean isHighlighted, boolean isVoicemail, boolean isEmergency) {  //MOTO Dialer Code
        mPhoneCallDetailsHelper.setPhoneCallDetails(views.phoneCallDetailsViews, details,
                isHighlighted, isVoicemail, isEmergency);  //MOTO Dialer Code
        ...
        //If number is empty or unknown number, then quick contact badage shall not be clickable.
        views.quickContactView.setClickable(canCall);
    ...
    private void configureCallSecondaryAction(CallLogListItemViews views,
        ...
        views.secondaryActionView.setImageResource(R.drawable.ic_ab_call);
