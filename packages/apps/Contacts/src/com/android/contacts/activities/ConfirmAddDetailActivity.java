...
public class ConfirmAddDetailActivity extends Activity implements
    ...
    private static class QueryEntitiesTask extends AsyncTask<Intent, Void, EntityDeltaList> {
        ...
        protected EntityDeltaList doInBackground(Intent... params) {
            ...
            // MOTO MOD BEGIN IKHSS6-5565 -- normally it shall not happen
            if(data == null){
                return null;
            }
            // MOTO MOD END
        ...
        protected void onPostExecute(EntityDeltaList entityList) {
            ...
            // MOTO MOD BEGIN IKHSS6-5565
            if(entityList == null){
                activityTarget.setResult(RESULT_CANCELED);
                                ...
                                if (!TextUtils.isEmpty(mimeType)) {
                                    ...
                                    if (!TextUtils.isEmpty(value)) {
                                        ...
                                        if (Phone.CONTENT_ITEM_TYPE.equals(mimeType)) {
                                            ...
                                            value = PhoneNumberUtilsExt.formatNumber(ConfirmAddDetailActivity.this, value);
    ...
    private void bindEditor() {
        ...
        for (DataKind kind : mEditableAccountType.getSortedDataKinds()) {
            ...
            //MOTO MOD BEGIN, to avoid empty list being parsed in the delta.
            if (mMimetype.equals(kind.mimeType) && mState != null && mState.getMimeEntriesCount(mMimetype,false) != 0) {
            //MOTO MOD END
