...
public final class ShowOrCreateActivity extends ContactsActivity
    ...
    static final String ADD_CONTACT_DIALOG="com.motorola.contacts.ACTION_ADD_CONTACT_DIALOG";
    ...
    public void onQueryComplete(int token, Object cookie, Cursor cursor) {
        ...
        if (count == 1 && contactId != -1) {
            ...
            if (mCreateForce) {
                ...
                Intent i = new Intent(ADD_CONTACT_DIALOG);
                i.putExtras(mCreateExtras);
                startActivity(i);
                finish();
                //MOT MOD BEGIN IKHSS6UPGR-9089
            }
    ...
    protected Dialog onCreateDialog(int id) {
	    ...
	    case CREATE_CONTACT_DIALOG:
                ...
                //MOTO MOD start IKHSS7-18331
                return new AlertDialog.Builder(this)
                //MOTO MOD end IKHSS7-18331
