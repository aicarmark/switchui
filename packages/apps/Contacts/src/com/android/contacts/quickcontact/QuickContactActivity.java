...
public class QuickContactActivity extends Activity {
        ...
        public synchronized void onQueryComplete(int token, Object cookie, Cursor cursor) {
            try {
                if (isFinishing()) {
                    ...
                    if (Profile.CONTENT_URI.equals(mLookupUri)) {
                        Toast.makeText(QuickContactActivity.this, R.string.needSetupLocalProfile,
    ...
    private void bindData(Cursor cursor) {
                    ...
                    new AsyncTask<Void, Void, Bitmap>() {
                        ...
                        protected Bitmap doInBackground(Void... params) {
                            try {
                                ...
                                return BitmapFactory.decodeStream(fd.createInputStream(), null, options);
                                // MOT MOD END    IKHSS7-765
                            } catch (IOException e) {
        ...
        if (photoView != null) {
            if (HardCodedSources.ACCOUNT_TYPE_CARD.equals(cursor.getString(DataQuery.ACCOUNT_TYPE))) {
                    photoView.setImageResource(ContactPhotoManager.getCardResId(true, false));
            } else {
                ...
                photoView.setImageResource(ContactPhotoManager.getDefaultAvatarResId(true, this.getResources().getBoolean(R.bool.contacts_dark_ui)));
                }
            }
        }
