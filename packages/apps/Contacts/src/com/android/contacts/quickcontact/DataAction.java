...
public class DataAction implements Action {
        ...
        if (Phone.CONTENT_ITEM_TYPE.equals(mimeType)) {
            if (PhoneCapabilityTester.isPhone(mContext)) {
                ...
                if (!TextUtils.isEmpty(number)) {
                    ...
                    final Intent phoneIntent = hasPhone ? intent: null;
            ...
            if (PhoneCapabilityTester.isSipPhone(mContext)) {
                ...
                if (!TextUtils.isEmpty(address)) {
                    ...
                    // BEGIN Motorola, FTR 36344, IKHSS6-8444
                    MEDialer.onDial(mContext, mIntent, MEDialer.DialFrom.CONTACTS);
                    // END IKHSS6-8444
    ...
    public Drawable getAlternateIcon() {
        ...
        if (resPackageName == null ||
             Phone.CONTENT_ITEM_TYPE.equals(mMimeType) ) { //MOT MOD - IKHSS6-4883
