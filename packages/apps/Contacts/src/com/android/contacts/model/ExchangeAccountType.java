...
public class ExchangeAccountType extends BaseAccountType {
    ...
    public ExchangeAccountType(Context context, String resPackageName) {
        ...
        try {
            ...
            /**modify for SWITCHUITWOV-279 by bphx43 2012-10-23*/
...
/**SWITCHUITWOV-308 JB update : " Contacts name display overlap and force close when copy/paste contact name " by bphx43 2012-11-12*/
    ...
    protected DataKind addDataKindStructuredName(Context context) throws DefinitionException {
        ...
        kind.fieldList.add(new EditField(StructuredName.PREFIX, R.string.name_prefix,
                FLAGS_PERSON_NAME).setOptional(true).setMaxLength(AccountType.MAX_CHAR_LENGTH_FOR_NAME));
        kind.fieldList.add(new EditField(StructuredName.FAMILY_NAME,
                R.string.name_family, FLAGS_PERSON_NAME).setMaxLength(AccountType.MAX_CHAR_LENGTH_FOR_NAME));
...
//                R.string.name_middle, FLAGS_PERSON_NAME));
        kind.fieldList.add(new EditField(StructuredName.GIVEN_NAME,
                R.string.name_given, FLAGS_PERSON_NAME).setMaxLength(AccountType.MAX_CHAR_LENGTH_FOR_NAME));
        kind.fieldList.add(new EditField(StructuredName.SUFFIX,
                R.string.name_suffix, FLAGS_PERSON_NAME).setMaxLength(AccountType.MAX_CHAR_LENGTH_FOR_NAME));
...
//                    R.string.name_middle, FLAGS_PERSON_NAME).setOptional(true));
        ...
        kind.fieldList.add(new EditField(StructuredName.SUFFIX,
                R.string.name_suffix, FLAGS_PERSON_NAME).setOptional(true).setMaxLength(AccountType.MAX_CHAR_LENGTH_FOR_NAME));
    ...
    protected DataKind addDataKindPhone(Context context) throws DefinitionException {
        ...
        /**	SWITCHUITWOV-334 by bphx43 2012-11-22*/
        .setAcceptChars(Constants.validPhoneNumber)
        /**end */
        .setMaxLength(AccountType.MAX_CHAR_LENGTH_FOR_PHONE));
    ...
    protected DataKind addDataKindStructuredPostal(Context context) throws DefinitionException {
        ...
        // BEGIN Motorola, w21667  07/19/2011,  IKCBS-1976i / FID 35411 Contacts Localization
        final boolean useKoreanOrder =
            Locale.KOREAN.getLanguage().equals(Locale.getDefault().getLanguage());
        // END  IKCBS-1976i / FID 35411 Contacts Localization
        ...
        // BEGIN Motorola, w21667  07/19/2011,  IKCBS-1976 / FID 35411 Contacts Localization
            ...
            kind.fieldList.add(new EditField(StructuredPostal.STREET,
                    R.string.postal_street, FLAGS_POSTAL).setMaxLength(AccountType.MAX_CHAR_LENGTH_FOR_POSTAL));
        // END  IKCBS-1976 / FID 35411 Contacts Localization
        } else {
            kind.fieldList.add(new EditField(StructuredPostal.STREET,
                    R.string.postal_street, FLAGS_POSTAL).setMaxLength(AccountType.MAX_CHAR_LENGTH_FOR_POSTAL));
            kind.fieldList.add(new EditField(StructuredPostal.CITY,
    ...
    protected DataKind addDataKindNote(Context context) throws DefinitionException {
        ...
        kind.fieldList = Lists.newArrayList();
        kind.fieldList.add(new EditField(Note.NOTE, R.string.label_notes, FLAGS_NOTE).setMaxLength(AccountType.MAX_CHAR_LENGTH_FOR_NOTE));
