...
/**SWITCHUITWOV-308 JB update : " Contacts name display overlap and force close when copy/paste contact name " by bphx43 2012-11-12*/
    public static final int MAX_CHAR_LENGTH_FOR_NAME = 512;
    public static final int MAX_CHAR_LENGTH_FOR_PHONE = 512;
    public static final int MAX_CHAR_LENGTH_FOR_EMAIL = 512;
    public static final int MAX_CHAR_LENGTH_FOR_POSTAL = 1024;
    public static final int MAX_CHAR_LENGTH_FOR_IM = 512;
    public static final int MAX_CHAR_LENGTH_FOR_ORGANIZATION = 1024;
    public static final int MAX_CHAR_LENGTH_FOR_NOTE = 2048;
    public static final int MAX_CHAR_LENGTH_FOR_WEBSITE = 2048;
    public static final int MAX_CHAR_LENGTH_FOR_SIPADDRESS = 512;
    public static final int MAX_CHAR_LENGTH_FOR_RELATION = 512;
			/**end */
    /**
    ...
    public static final class EditField {
        ...
        public char[] acceptChars;

        public EditField(String column, int titleRes) {
            this.column = column;
            this.titleRes = titleRes;
            if(StructuredName.DISPLAY_NAME.equals(column)){
                maxLength = Constants.CONTACTS_NAME_MAX_LENGTH;
            } else if(StructuredName.PREFIX.equals(column)){
                maxLength = Constants.CONTACTS_NAME_MAX_LENGTH / 5;
                ...
                maxLength = Constants.CONTACTS_FIELD_MAX_LENGTH; //set defult max length
            }
            acceptChars = null;
        }
        ...
        public EditField setMaxLength(int maxLength) {
            this.maxLength = maxLength;
            return this;
        }

        public EditField setAcceptChars(char[] acceptChars) {
