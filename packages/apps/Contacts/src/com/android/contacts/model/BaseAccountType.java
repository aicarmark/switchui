...
public abstract class BaseAccountType extends AccountType {
    ...
    private interface Weight {
        ...
        static final int ORGANIZATION = 30; // MOT CHINA
...
/**SWITCHUITWOV-308 JB update : " Contacts name display overlap and force close when copy/paste contact name " by bphx43 2012-11-12*/
    protected DataKind addDataKindStructuredName(Context context) throws DefinitionException {
        ...
        kind.fieldList.add(new EditField(StructuredName.DISPLAY_NAME,
                R.string.full_name, FLAGS_PERSON_NAME).setMaxLength(AccountType.MAX_CHAR_LENGTH_FOR_NAME));
        kind.fieldList.add(new EditField(StructuredName.PREFIX, R.string.name_prefix,
                FLAGS_PERSON_NAME).setLongForm(true).setMaxLength(AccountType.MAX_CHAR_LENGTH_FOR_NAME));
        kind.fieldList.add(new EditField(StructuredName.FAMILY_NAME, R.string.name_family,
                FLAGS_PERSON_NAME).setLongForm(true).setMaxLength(AccountType.MAX_CHAR_LENGTH_FOR_NAME));
     // 2012.08.24 to fix IKCBSMMCPPRC-1751 to remove the middle name
...
//                FLAGS_PERSON_NAME).setLongForm(true));
        ...
        kind.fieldList.add(new EditField(StructuredName.PHONETIC_FAMILY_NAME,
                R.string.name_phonetic_family, FLAGS_PHONETIC).setMaxLength(AccountType.MAX_CHAR_LENGTH_FOR_NAME));
        kind.fieldList.add(new EditField(StructuredName.PHONETIC_MIDDLE_NAME,
                R.string.name_phonetic_middle, FLAGS_PHONETIC).setMaxLength(AccountType.MAX_CHAR_LENGTH_FOR_NAME));
        kind.fieldList.add(new EditField(StructuredName.PHONETIC_GIVEN_NAME,
                R.string.name_phonetic_given, FLAGS_PHONETIC).setMaxLength(AccountType.MAX_CHAR_LENGTH_FOR_NAME));
...
/**SWITCHUITWOV-308 JB update : " Contacts name display overlap and force close when copy/paste contact name " by bphx43 2012-11-12*/
    protected DataKind addDataKindDisplayName(Context context) throws DefinitionException {
        ...
        kind.fieldList = Lists.newArrayList();
        kind.fieldList.add(new EditField(StructuredName.DISPLAY_NAME,
                R.string.full_name, FLAGS_PERSON_NAME).setShortForm(true).setMaxLength(AccountType.MAX_CHAR_LENGTH_FOR_NAME));
...
//                    FLAGS_PERSON_NAME).setLongForm(true));
	...
	/**end*/
/**JB update : " Contacts name display overlap and force close when copy/paste contact name " by bphx43 2012-11-12*/
    protected DataKind addDataKindPhoneticName(Context context) throws DefinitionException {
        ...
        kind.fieldList.add(new EditField(DataKind.PSEUDO_COLUMN_PHONETIC_NAME,
                R.string.name_phonetic, FLAGS_PHONETIC).setShortForm(true).setMaxLength(AccountType.MAX_CHAR_LENGTH_FOR_NAME));
        kind.fieldList.add(new EditField(StructuredName.PHONETIC_FAMILY_NAME,
                R.string.name_phonetic_family, FLAGS_PHONETIC).setLongForm(true).setMaxLength(AccountType.MAX_CHAR_LENGTH_FOR_NAME));
        kind.fieldList.add(new EditField(StructuredName.PHONETIC_MIDDLE_NAME,
                R.string.name_phonetic_middle, FLAGS_PHONETIC).setLongForm(true).setMaxLength(AccountType.MAX_CHAR_LENGTH_FOR_NAME));
        kind.fieldList.add(new EditField(StructuredName.PHONETIC_GIVEN_NAME,
                R.string.name_phonetic_given, FLAGS_PHONETIC).setLongForm(true).setMaxLength(AccountType.MAX_CHAR_LENGTH_FOR_NAME));
...
/**SWITCHUITWOV-308 JB update : " Contacts name display overlap and force close when copy/paste contact name " by bphx43 2012-11-12*/
    protected DataKind addDataKindNickname(Context context) throws DefinitionException {
        ...
        kind.fieldList.add(new EditField(Nickname.NAME, R.string.nicknameLabelsGroup,
                FLAGS_PERSON_NAME).setMaxLength(AccountType.MAX_CHAR_LENGTH_FOR_NAME));
...
/**SWITCHUITWOV-308 JB update : " Contacts name display overlap and force close when copy/paste contact name " by bphx43 2012-11-12*/
    protected DataKind addDataKindPhone(Context context) throws DefinitionException {
        ...
        kind.fieldList = Lists.newArrayList();
        kind.fieldList.add(new EditField(Phone.NUMBER, R.string.phoneLabelsGroup, FLAGS_PHONE).setAcceptChars(Constants.validPhoneNumber).setMaxLength(AccountType.MAX_CHAR_LENGTH_FOR_PHONE));
...
/**SWITCHUITWOV-308 JB update : " Contacts name display overlap and force close when copy/paste contact name " by bphx43 2012-11-12*/
    protected DataKind addDataKindEmail(Context context) throws DefinitionException {
        ...
        kind.fieldList = Lists.newArrayList();
        kind.fieldList.add(new EditField(Email.DATA, R.string.emailLabelsGroup, FLAGS_EMAIL).setMaxLength(AccountType.MAX_CHAR_LENGTH_FOR_EMAIL));
...
/**SWITCHUITWOV-308 JB update : " Contacts name display overlap and force close when copy/paste contact name " by bphx43 2012-11-12*/
    protected DataKind addDataKindIm(Context context) throws DefinitionException {
        ...
        kind.fieldList = Lists.newArrayList();
        kind.fieldList.add(new EditField(Im.DATA, R.string.imLabelsGroup, FLAGS_EMAIL).setMaxLength(AccountType.MAX_CHAR_LENGTH_FOR_IM));
...
/**SWITCHUITWOV-308 JB update : " Contacts name display overlap and force close when copy/paste contact name " by bphx43 2012-11-12*/
    protected DataKind addDataKindOrganization(Context context) throws DefinitionException {
        DataKind kind = addKind(new DataKind(Organization.CONTENT_ITEM_TYPE,
                    R.string.organizationLabelsGroup, 30, true, // MOT CHINA
                    R.layout.text_fields_editor_view));
        ...
        kind.fieldList.add(new EditField(Organization.COMPANY, R.string.ghostData_company,
                FLAGS_GENERIC_NAME).setMaxLength(AccountType.MAX_CHAR_LENGTH_FOR_ORGANIZATION));
    ...
    protected DataKind addDataKindNote(Context context) throws DefinitionException {
        ...
        kind.fieldList = Lists.newArrayList();
        kind.fieldList.add((new EditField(Note.NOTE, R.string.label_notes, FLAGS_NOTE)).setMaxLength(Constants.NOTES_MAX_LENGTH));
...
/**SWITCHUITWOV-308 JB update : " Contacts name display overlap and force close when copy/paste contact name " by bphx43 2012-11-12*/
    protected DataKind addDataKindWebsite(Context context) throws DefinitionException {
        ...
        kind.fieldList = Lists.newArrayList();
        kind.fieldList.add(new EditField(Website.URL, R.string.websiteLabelsGroup, FLAGS_WEBSITE).setMaxLength(AccountType.MAX_CHAR_LENGTH_FOR_WEBSITE));
    ...
    protected DataKind addDataKindSipAddress(Context context) throws DefinitionException {
        ...
        kind.fieldList.add(new EditField(SipAddress.SIP_ADDRESS,
                                         R.string.label_sip_address, FLAGS_SIP_ADDRESS).setMaxLength(AccountType.MAX_CHAR_LENGTH_FOR_SIPADDRESS));
...
//                        FLAGS_PERSON_NAME).setLongForm(true));
    ...
    private static class StructuredPostalKindBuilder extends KindBuilder {
        ...
        public List<DataKind> parseDataKind(Context context, XmlPullParser parser,
                AttributeSet attrs) throws DefinitionException, XmlPullParserException,
                IOException {
            // BEGIN Motorola, jcui1, 4/4/2012, IKHSS6UPGR-5203
            final boolean needsStructured = getAttr(attrs, "needsStructured", false);
            // END IKHSS6UPGR-5203
            ...
            // BEGIN Motorola, jcui1, 4/4/2012, IKHSS6UPGR-5203
            if (Log.isLoggable(TAG, Log.DEBUG)) {
                Log.d(TAG, "needsStructured = " + needsStructured);
            }
            if (needsStructured) {
            // END IKHSS6UPGR-5203
                if (Locale.JAPANESE.getLanguage().equals(Locale.getDefault().getLanguage())) {
                    ...
                    kind.fieldList.add(new EditField(StructuredPostal.COUNTRY,
                            R.string.postal_country, FLAGS_POSTAL).setOptional(true).setMaxLength(AccountType.MAX_CHAR_LENGTH_FOR_POSTAL));
                    kind.fieldList.add(new EditField(StructuredPostal.POSTCODE,
                            R.string.postal_postcode, FLAGS_POSTAL).setMaxLength(AccountType.MAX_CHAR_LENGTH_FOR_POSTAL));
                    kind.fieldList.add(new EditField(StructuredPostal.REGION,
                            R.string.postal_region, FLAGS_POSTAL).setMaxLength(AccountType.MAX_CHAR_LENGTH_FOR_POSTAL));
                    kind.fieldList.add(new EditField(StructuredPostal.CITY,
                            R.string.postal_city,FLAGS_POSTAL).setMaxLength(AccountType.MAX_CHAR_LENGTH_FOR_POSTAL));
                    kind.fieldList.add(new EditField(StructuredPostal.STREET,
                            R.string.postal_street, FLAGS_POSTAL).setMaxLength(AccountType.MAX_CHAR_LENGTH_FOR_POSTAL));
                } else {
                    // Generic order
                    kind.fieldList.add(new EditField(StructuredPostal.STREET,
                            R.string.postal_street, FLAGS_POSTAL).setMaxLength(AccountType.MAX_CHAR_LENGTH_FOR_POSTAL));
                ...
                kind.fieldList.add(
                        new EditField(StructuredPostal.FORMATTED_ADDRESS, R.string.postal_address,
                                FLAGS_POSTAL).setMaxLength(AccountType.MAX_CHAR_LENGTH_FOR_POSTAL));
            }
    ...
    private static class ImKindBuilder extends KindBuilder {
        ...
        public List<DataKind> parseDataKind(Context context, XmlPullParser parser,
            ...
            kind.fieldList.add(new EditField(Im.DATA, R.string.imLabelsGroup, FLAGS_EMAIL).setMaxLength(AccountType.MAX_CHAR_LENGTH_FOR_EMAIL));
