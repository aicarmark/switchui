                ...
                if (filter.filterType == ContactListFilter.FILTER_TYPE_ALL_ACCOUNTS) {
                    ...
                    if (HardCodedSources.ACCOUNT_LOCAL_DEVICE.equals(filter.accountName)) {
                        headerTextView.setText(context.getString(
                                R.string.listAllContactsInAccount, context.getString(R.string.account_local_device)));
                    } else if (HardCodedSources.ACCOUNT_CARD_C.equals(filter.accountName)) {
                        headerTextView.setText(context.getString(
                                R.string.listAllContactsInAccount, context.getString(R.string.account_card_C)));
                    } else if (HardCodedSources.ACCOUNT_CARD_G.equals(filter.accountName)) {
                        headerTextView.setText(context.getString(
                                R.string.listAllContactsInAccount, context.getString(R.string.account_card_G)));
                        ...
                        if (phoneType == TelephonyManager.PHONE_TYPE_CDMA) {
                            headerTextView.setText(context.getString(
                                    R.string.listAllContactsInAccount, context.getString(R.string.account_card_uim)));
                        } else {
                            headerTextView.setText(context.getString(
                                    R.string.listAllContactsInAccount, context.getString(R.string.account_card_G)));
                        }
