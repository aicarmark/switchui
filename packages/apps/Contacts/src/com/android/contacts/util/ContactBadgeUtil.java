...
public class ContactBadgeUtil {
    ...
    public static Bitmap loadCardPhoto(Context context, boolean hires, boolean darkTheme) {
        return BitmapFactory.decodeResource(context.getResources(),
                ContactPhotoManager.getCardResId(hires, darkTheme));
    }
    ...
    public static Bitmap loadDefaultAvatarPhoto(Context context, boolean hires, boolean darkTheme) {
        ...
        return BitmapFactory.decodeResource(context.getResources(),
                ContactPhotoManager.getDefaultAvatarResId(hires, darkTheme), options);
        // MOT MOD END    IKHSS7-765
    }
}
