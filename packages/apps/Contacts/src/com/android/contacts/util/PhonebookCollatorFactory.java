...
public final class PhonebookCollatorFactory {
    public static final Collator getCollator() {
        ...
        // the framework)
        final Locale locale;
        // BEGIN Motorola, w21652 01/27/2012, IKHSS6UPGR-260 / FID 37309 List Accelerator for Korean in contacts
        // Add conditions for "ko" and "ko_KR"
        if ("ja".equals(defaultLocaleString) || "ja_JP".equals(defaultLocaleString) || "ko".equals(defaultLocaleString) || "ko_KR".equals(defaultLocaleString)) {
        // END IKHSS6UPGR-260 FID 37309
