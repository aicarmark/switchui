...
public class WeatherScreenConfig {
    ...
    public static final int BG_DEDLAY_TIME = 200;       

    private static final int GENERIC_PROTRAIT_OR_LANDSCAPE = LANDSCAPE_ONLY;

    public static final  int[] PROTRAIT_OR_LANDSCAPE = null;// new int[]{LANDSCAPE_ONLY,LANDSCAPE_ONLY,LANDSCAPE_ONLY,LANDSCAPE_ONLY};//new int[]{PROTRAIT_AND_LANDSCAPE,PROTRAIT_AND_LANDSCAPE,PROTRAIT_AND_LANDSCAPE,PROTRAIT_AND_LANDSCAPE};
    
    
    public static int getResType() {
    	return ANIMATION_RES_ONLY;
    }
