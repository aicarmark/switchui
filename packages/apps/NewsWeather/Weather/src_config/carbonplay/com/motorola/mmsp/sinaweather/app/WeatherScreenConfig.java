...
public class WeatherScreenConfig {
    ...
    public static final  int[] PROTRAIT_OR_LANDSCAPE = null;//new int[]{PROTRAIT_AND_LANDSCAPE,PROTRAIT_AND_LANDSCAPE,PROTRAIT_AND_LANDSCAPE,PROTRAIT_AND_LANDSCAPE};
