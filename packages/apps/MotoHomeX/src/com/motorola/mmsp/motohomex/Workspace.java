...
/*2012-4-26, add by e13775 for SWITCHUI-865 to update stk shortcut*/
import android.content.pm.ActivityInfo;
/*2012-4-26, add by e13775 for SWITCHUI-865 to update stk shortcut end*/
import com.motorola.mmsp.motohomex.R;
import com.motorola.mmsp.motohomex.FolderIcon.FolderRingAnimator;
...
public class Workspace extends SmoothPagedView
	...
	//2012-02-09 added by RJG678
    final static int MAX_PANEL_SIZE = 9;
    // added by RJG678 End
    ...
    /*2012-05-14, Chen Yidong, for switchui-1098*/
    private boolean mDragScaleFlag = false;
    /*2012-05-14, end*/
	
	/*2012-02-16 added by rjg678 for IKSWITCHUI-20*/
    private final int[] defaultScreen=new int []{0,0,1,1,2,2,3,3,4};
    /*ended by rjg678*/
    /**
    ...
    public Workspace(Context context, AttributeSet attrs, int defStyle) {
        ...
        /*2012-11-20, Modifyed by chenjing for switchuitwo-56*/
        ...
        mDefaultPage = defaultScreen[mLauncher.getPanelNumber()-1];
        Log.d(TAG, " Workspace mDefaultPage=" + mDefaultPage);
        /*2012-11-20, Modify end*/
        initWorkspace();
    ...
    /* added by amt_wangpeipei 2012/04/10 SWITCHUI-273 begin*/    
    @Override
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    	super.onMeasure(widthMeasureSpec, heightMeasureSpec);
        CellLayout cell = (CellLayout)getChildAt(0);
        /* 2012-5-22 modified by e13775 for SWITCHUI-1209 */
        /*2012-7-16, remove checking gap for switchui-2249 by bvq783*/
        if(/*cell.getHeightGap() < 0 ||*/Flex.getSearchBarHideSetting(getContext()))
        /* 2012-5-22 modified by e13775 for SWITCHUI-1209 end*/
        {
        	mLauncher.getSearchBar().setIsQSBarHide(true);
        	setPadding(getPaddingLeft(), 0, getPaddingRight(), getPaddingBottom());
        	mLauncher.getSearchBar().setQSBarGone();
        }
    }
    /*added end*/
    ...
    public void onUpdateDefaultPage(){

        if(this.getChildCount()>0){
            mDefaultPage = defaultScreen[this.getChildCount() -1];
        }

    }
	// end by rjg678
	
    //2012-02-17 added by rjg678 for IKSWITCHUI-23
    ...
    /*
     *   Initialize the count of Celllayout in Workspace
     */
    public void setScreenCount( int scrCount ){
        if( scrCount < 1 ) return;
 ...
 // RJG678 Pinch Panel END
    ...
    /*2012-05-14, Chen Yidong, for switchui-1098*/
    public void setSwitchingState(boolean state) {
        mIsSwitchingState = state;
    }
    /*2012-05-14, end*/
    ...
    protected void onPageBeginMoving() {
        ...
        /*add by bvq783 for call pluginwidget to do action when start scrolling*/
        /*2012-6-7, modifyed by bvq783 for switchui-1936*/
        //boolean def = mLauncher.getWorkspaceEffect()==0 ? true : false;
        endAllPagesListener();
        /*2012-6-7, modifyed by bvq783 end*/
        /*add by bvq783 end*/
        ...
        Log.d("July", "workspace on page begin moving to show scrolling indicator");
        showScrollingIndicator(false);
    }

    protected void onPageEndMoving() {
        super.onPageEndMoving();
        /*add by bvq783 for call pluginwidget to do action when finish scrolling*/
        /*2012-6-7, modifyed by bvq783 for switchui-1936*/
        //boolean def = mLauncher.getWorkspaceEffect()==0 ? true : false;
        startAllPagesListener();
        /*2012-6-7, modifyed by bvq783 end*/
        /*add by bvq783 end*/
        ...
        if (mDragController.isDragging()) {
            ...
            if (!mDragController.isDragging()) {
                Log.d("July", "Workspace page end moving to hide scrolling indicator");
    ...
    protected void snapToPage(int whichPage) {
        /*2012-7-9, add by bvq783 for switchui-2020*/
        if (mCurrentPage == whichPage)
            return;
        /*2012-7-9, add end*/
        super.snapToPage(whichPage);
        computeWallpaperScrollRatio(whichPage);
        /*2012-7-2,add by bvq783 for switchui-1796*/
    ...
    protected void screenScrolled(int screenCenter) {
        ...
        if (!isSmall() && !isSwitchingState()) {
            /*2012-05-18, added by Bai Jian for SWITCHUI-1176*/
            if (mWithEffect) pt.screenScrolled(this, screenCenter);
            /*2012-05-18, added end*/
        }
		/*
    ...
    */
    ...
    private void initAnimationArrays() {
        //2012-02-09 remove by RJG678
        //final int childCount = getChildCount();
        if (mOldTranslationXs != null) return;
        mOldTranslationXs = new float[MAX_PANEL_SIZE];
        mOldTranslationYs = new float[MAX_PANEL_SIZE];
        mOldScaleXs = new float[MAX_PANEL_SIZE];
        mOldScaleYs = new float[MAX_PANEL_SIZE];
        mOldBackgroundAlphas = new float[MAX_PANEL_SIZE];
        mOldAlphas = new float[MAX_PANEL_SIZE];
        mNewTranslationXs = new float[MAX_PANEL_SIZE];
        mNewTranslationYs = new float[MAX_PANEL_SIZE];
        mNewScaleXs = new float[MAX_PANEL_SIZE];
        mNewScaleYs = new float[MAX_PANEL_SIZE];
        mNewBackgroundAlphas = new float[MAX_PANEL_SIZE];
        mNewAlphas = new float[MAX_PANEL_SIZE];
        mNewRotationYs = new float[MAX_PANEL_SIZE];
    }
    ...
    public void onLauncherTransitionPrepare(Launcher l, boolean animated, boolean toWorkspace) {
        Log.d("July", "Workspace onLauncherTransitionPrepare to cancel scrolling indicator anim");
    ...
    public Bitmap createDragBitmap(View v, Canvas canvas, int padding) {
        ...
        //2012-09-04, ChenYidong for SWITCHUI-2603
        ...
        if (v instanceof TextView) {
            ...
            if(v instanceof LauncherAppWidgetHostView
                    || v instanceof PluginWidgetHostView){
                needScale = true;
            }
            //2012-09-04, end
        }
        ...
        if(needScale){
            ...
            PaintFlagsDrawFilter newdrawfilter = new
                    PaintFlagsDrawFilter(0, Paint.ANTI_ALIAS_FLAG|Paint.FILTER_BITMAP_FLAG);
            canvas.setDrawFilter(newdrawfilter);
            Bitmap bb = Bitmap.createBitmap(nw, nh, Bitmap.Config.ARGB_8888);
            canvas.setBitmap(bb);
            canvas.drawBitmap(b, new Rect(0, 0, w, h), new Rect(0, 0, nw, nh), new Paint());
            b.recycle();
    ...
    public void beginDragShared(View child, DragSource source) {
        ...
        if(mLauncher.getSearchBar().getIsQSBarHide() && source instanceof Folder){
            mLauncher.enterSpringLoadedDragModeOnWorkspace();
        }
        /* modified end*/
        if(mLauncher.getSearchBar().getIsQSBarHide()){
            mDragScaleFlag = false;
            if(source instanceof Workspace && child != null){
        ...
        if (child instanceof PluginWidgetHostView) {
            PluginWidgetDragListener listener = (PluginWidgetDragListener)(
                    ((PluginWidgetHostView)child).getDragListener());
            if (listener != null) {
        ...
        b.recycle();
        Log.d("July", "Workspace begin drag shared to show scrolling indicator");
        // Show the scrolling indicator when you pick up an item
        //2012 09-06, ChenYidong for SWITCHUI-2686
        //showScrollingIndicator(false);
    ...
    public boolean acceptDrop(DragObject d) {
        ...
        if (d.dragSource != this) {
            ...
            /*2012-11-3, add by 003033 for switchui-3022, don't accept drop if draginfo is null*/
            if (d.dragInfo == null)
                return false;
            /*2012-11-3, add end*/
            ...
            if (d.dragInfo instanceof PendingAddWidgetInfo) {
                //2012-09-07, ChenYidong for SWITCHUI-2647
                if(((PendingAddWidgetInfo) d.dragInfo).itemType != LauncherSettings.Favorites.ITEM_TYPE_PLUGINWIDGET){
            ...
            if (!foundCell) {
                ...
                // is full
                /*2012-07-19, ChenYidong for SWITCHUI-2353*/
                boolean isHotseatLayout = false;
                //boolean isHotseat = mLauncher.isHotseatLayout(dropTargetLayout);
                if (mTargetCell != null && mLauncher.isHotseatLayout(dropTargetLayout)) {
                    Hotseat hotseat = mLauncher.getHotseat();
                    if (hotseat.isAllAppsButtonRank(
                            hotseat.getOrderInHotseat(mTargetCell[0], mTargetCell[1]))) {
                        return false;
                    }
                    isHotseatLayout = true;
                }
    ...
    boolean createUserFolderIfNecessary(View newView, long container, CellLayout target,
        ...
        if (aboveShortcut && willBecomeShortcut) {
            ...
            if (!external) {
                //2012-07-24, Chen Yidong for null pointer crash, switchui-2465
                //getParentCellLayoutForView(mDragInfo.cell).removeView(mDragInfo.cell);
	         ViewGroup vg = getParentCellLayoutForView(mDragInfo.cell);
                if(vg != null){
    ...
    public void onDrop(final DragObject d) {
        ...
        if (d.dragSource != this) {
            ...
            //2012-08-30, ChenYidong for crash cell.getParent() == null
            //final CellLayout parent = (CellLayout) cell.getParent().getParent();
            ViewParent tempParent = cell.getParent();
            if (tempParent == null) {
                Log.i(TAG, "Drag failed; View has no parent: " + cell.toString());
                return;
            }

            final CellLayout parent = (CellLayout) tempParent.getParent();
            if (parent == null) {
                Log.i(TAG, "Drag failed; View has no grandparent. view: " + cell.toString() +
                        " view.parent: " + tempParent.toString());
                return;
            }
            //2012-08-30, end
    ...
    public void onDragEnter(DragObject d) {
        ...
        //2012-09-06, ChenYidong for SWITCHUI-2709 highlight display wrong when drag hotseat shortcuts
        boolean need = true;
        if(d != null && d.dragSource instanceof Workspace && d.dragInfo instanceof ItemInfo){
   ...
   static private float squaredDistance(float[] point1, float[] point2) {
    ...
    private boolean isExternalDragWidget(DragObject d) {
        /*2012-09-03, added by ChenYidong SWITCHUI-2605, for widget can drag into hotseat*/
        if (d.dragSource == this) {
            return isDragWidget(d);
        }
        /*2012-09-03, added end*/
    ...
    public void onDragOver(DragObject d) {
        ...
        ItemInfo item = (ItemInfo) d.dragInfo;
        /*2012-11-2, add by 003033 for switchui-3022*/
        if (item == null)   return;
        /*2012-11-2, add end*/
        ...
        if (mDragTargetLayout != null) {
            ...
            /*2012-8-3, add by bvq783 for plugin*/
            if (child != null && child instanceof PluginWidgetHostView) {
                PluginWidgetDragListener listener = (PluginWidgetDragListener)(
                        ((PluginWidgetHostView)child).getDragListener());
                if (listener != null) {
                    listener.onDragMoving();
                }
            }
            /*2012-8-3, add end*/
    ...
    private void onDropExternal(final int[] touchXY, final Object dragInfo,
        ...
        if (info instanceof PendingAddItemInfo) {
            ...
            Runnable onAnimationCompleteRunnable = new Runnable() {
                ...
                public void run() {
                    ...
                    case LauncherSettings.Favorites.ITEM_TYPE_SHORTCUT:
                        ...
                        break;
                    /*2012-8-3, add by bvq783 for plugin*/
                    case LauncherSettings.Favorites.ITEM_TYPE_PLUGINWIDGET:
                        int spanP[] = new int[2];
                        spanP[0] = item.spanX;
                        spanP[1] = item.spanY;
                        mLauncher.addPluginWidgetFromDrop(pendingInfo.componentName,
                                container, screen, mTargetCell, spanP, null);
                        break;
                    /*2012-8-3, add end*/
                    default:
		    ...
		    Log.d(TAG,"info.flags =="  + ((ApplicationInfo)info).flags);
		    if(((ApplicationInfo)info).flags == ApplicationInfo.FAKE_APP_FLAG){
		        Bitmap icon = ((ApplicationInfo) info).iconBitmap;
    ...
    public void setFinalTransitionTransform(CellLayout layout) {
        if (isSwitchingState()) {
            ...
            //added by amt_wangpeipei 2012/08/15 for switchui-2549 begin
            index = (index == -1 ? 0 : index);
            //added by amt_wangpeipei 2012/08/15 for switchui-2549 end
            ...
            //2012-09-06, ChenYidong for SWITCHUI-2719
            if(index >=0 && index < mNewScaleXs.length){
    ...
    public void onDropCompleted(View target, DragObject d, boolean isFlingToDelete,
        ...
        if (mDragInfo.cell != null) {
            ...
            if (cell instanceof PluginWidgetHostView) {
                PluginWidgetDragListener listener = (PluginWidgetDragListener)(
                        ((PluginWidgetHostView)cell).getDragListener());
                if (listener != null) {
                    listener.onDragEnd();
                }
            }
        ...
        /* added by amt_wangpeipei 2012/04/06 SWITCHUI-273 begin*/
        if(mLauncher.getSearchBar().getIsQSBarHide()){
        	onDragStopped(success);
        	
        	// Exit spring loaded mode if we have not successfully dropped or have not handled the
        	// drop in Workspace
        	mLauncher.exitSpringLoadedDragModeOnWorkspace();        
        	mLauncher.unlockScreenOrientation(false);
        }
        /* added end*/
    ...
    void removeItems(final ArrayList<ApplicationInfo> apps) {
        ...
        for (final CellLayout layoutParent: cellLayouts) {
        	// 2012-09-28, Modifyed by amt_chenjing, since the  mShortcutsAndWidgets may changed after removeing items
        	// So, we need to reget them after proper operation
            ...
            post(new Runnable() {
                public void run() {
                    ...
                    final ArrayList<View> shortcutsAndWidgets = new ArrayList<View>();
                    shortcutsAndWidgets.clear();
                    int childCount = layout.getChildCount();
                    for (int j = 0; j < childCount; j++) {
                    	shortcutsAndWidgets.add(layout.getChildAt(j));
                    }
                    for (int j = 0; j < childCount; j++) {
                        final View view = shortcutsAndWidgets.get(j);
                    ...
                    layout = layoutParent.getShortcutsAndWidgets();
                    shortcutsAndWidgets.clear();
        ...
        post(new Runnable() {
            ...
            public void run() {
                ...
                for (String packageName: packageNames) {
                    ...
                    //2012-09-07, ChenYidong for SWITCHUI-2731, can't use the ArrayList when it is being modified.
                    try{
                        ...
                        Log.i(TAG, "catch a ConcurrentModificationException in removeItems. ex: " + ce);
                    }
                    //2012-09-07, end
                ...
                if (tag instanceof ShortcutInfo) {
                    ...
                    if (info.itemType == LauncherSettings.Favorites.ITEM_TYPE_APPLICATION &&
                        ...
                        for (int k = 0; k < appCount; k++) {
                            ...
                            /*2012-4-26, add by e13775 for SWITCHUI-865 to update stk shortcut*/
                            if (app.componentName.getPackageName().equals("com.android.stk")){          
                                try{
                                    ActivityInfo activityInfo = getContext().getPackageManager().getActivityInfo(name, 0);
                                    String title = activityInfo.loadLabel(getContext().getPackageManager()).toString();
                                    if (title != null) {
                                        info.title = title;
                                        ((TextView) view).setText(title);
                                    }
                                }catch(Exception e){
                                    Log.e(TAG,"update shortcuts exception :" + e);
                                }
                            }
                            /*2012-4-26, add by e13775 for SWITCHUI-865 to update stk shortcut end*/
                            }
    ...
    void moveToDefaultScreen(boolean animate) {
        if (!isSmall()) {
            /*2012-6-7, added by bvq783 for switchui-1936*/
            /*stop current page's animation*/
            endOnePageListener(mCurrentPage);
            /*2012-6-7, added by bvq783 end*/
            if (animate) {
            ...
            /*2012-6-7, added by bvq783 for switchui-1936*/
            /*start current page's animation*/
            startOnePageListener(mDefaultPage);
            /*2012-6-7, added by bvq783 end*/
        }
    ...
    /*2012-8-3, add by bvq783 to remove plugin widgets in workspace when widget is uninstalled*/
    void removePluginItems(final String[] widgets) {
        ArrayList<CellLayout> cellLayouts = getWorkspaceAndHotseatCellLayouts();
        for (final CellLayout layoutParent: cellLayouts) {
            final ViewGroup layout = layoutParent.getShortcutsAndWidgets();
            ...
            post(new Runnable() {
                public void run() {
                    ...
                    for (int j = 0; j < childCount; j++) {
                        ...
                        if (tag instanceof LauncherPluginWidgetInfo) {
                            final LauncherPluginWidgetInfo info = (LauncherPluginWidgetInfo) tag;
                            if (info.key != null) {
                                for (int i=0; i<widgets.length; i++) {
                                	String packageName = widgets[i];
                                    if (packageName.equals(info.key)) {
                                        mLauncher.removePluginWidget(info);
                                        LauncherModel.deleteItemFromDatabase(mLauncher, info);
                                        childrenToRemove.add(view);
                                    }
                                }
    ...
    public void removeFakeItems(final ArrayList<ApplicationInfo> apps){
	Log.d(TAG,"removeFakeItems---enter");
        final HashSet<String> packageNames = new HashSet<String>();
        final int appCount = apps.size();
        for (int i = 0; i < appCount; i++) {
	    Log.d(TAG,"removeFakeItems---i ==" + i + ", PackageName =="  + apps.get(i).componentName.getPackageName());
            packageNames.add(apps.get(i).componentName.getPackageName());
        }
        ...
        for (final CellLayout layoutParent: cellLayouts) {
            ...
            post(new Runnable() {
                public void run() {
                    ...
                    int childCount = layout.getChildCount();
		    Log.d(TAG,"removeFakeItems ----childCount ==" + childCount);
                    for (int j = 0; j < childCount; j++) {
                        final View view = layout.getChildAt(j);
                        Object tag = view.getTag();
                        ...
                        if (tag instanceof ShortcutInfo) {
                            final ShortcutInfo info = (ShortcutInfo) tag;
                            final Intent intent = info.intent;
			    final String cmpName = intent.getStringExtra(FakeAppModel.EXTRA_COMPONENT);
			    Log.d(TAG,"removeFakeItems --1--cmpName ==" + cmpName );
			    if(cmpName == null) continue;
                            final ComponentName name = ComponentName.unflattenFromString(cmpName);
			    Log.d(TAG,"removeFakeItems --1--name ==" +  name);
			    	...
			    	if(cmpName == null) continue;
                            	final ComponentName name = ComponentName.unflattenFromString(cmpName);
			    	Log.d(TAG,"removeFakeItems --2--cmpName ==" + cmpName );
 			    	Log.d(TAG,"removeFakeItems --2--name ==" +  name);
                    ...
                    childCount = childrenToRemove.size();
	   	 Log.d(TAG,"removeFakeItems ----childrenToRemove ==" + childCount);
                    ...
                    for (int j = 0; j < childCount; j++) {
                        ...
                        // does not re-mark the spaces as unoccupied.
                        layoutParent.removeViewInLayout(child);
			 Log.d(TAG,"removeFakeItems --removeViewInLayout--child ==" +  child);
                    ...
                    if (childCount > 0) {
                        layout.requestLayout();
                        layout.invalidate();
			 Log.d(TAG,"removeFakeItems --invalidate");
    ...
    public void startAllPagesListener() {
        ArrayList<LauncherPluginWidgetInfo> widget = mLauncher.getPluginWidgets();
        if (widget != null) {
            int num = widget.size();
            for (int i=0; i<num; i++) {
                LauncherPluginWidgetInfo info = widget.get(i);
                PluginWidgetHostView v = (PluginWidgetHostView)info.hostView;
                if (v != null) {
                    PluginWidgetScrollListener listener = (PluginWidgetScrollListener)(v.getScrollListener());
                    if (listener != null) {
                        listener.finishScrolling(false);
                    }
                }
            }
        }
    ...
    public void endAllPagesListener() {
        ArrayList<LauncherPluginWidgetInfo> widget = mLauncher.getPluginWidgets();
        if (widget != null) {
            int num = widget.size();
            for (int i=0; i<num; i++) {
    ...
    public void startOnePageListener(int page) {
        ArrayList<LauncherPluginWidgetInfo> widget = mLauncher.getPluginWidgets();
        if (widget != null) {
            int num = widget.size();
            for (int i=0; i<num; i++) {
    ...
    public void endOnePageListener(int page) {
        ArrayList<LauncherPluginWidgetInfo> widget = mLauncher.getPluginWidgets();
        if (widget != null) {
            int num = widget.size();
            for (int i=0; i<num; i++) {
