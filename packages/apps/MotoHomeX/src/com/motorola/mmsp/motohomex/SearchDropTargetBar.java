...
public class SearchDropTargetBar extends FrameLayout implements DragController.DragListener {
	/* added by amt_wangpeipei 2012/04/07 SWITCHUI-273 begin*/
	private boolean isQSBarHide = false;
	/*add end*/
    ...
    /*added by amt_wangpeipei 2012/04/09 SWITCHUI-273 begin */
    public void setIsQSBarHide(boolean isQSBarHide) {
		this.isQSBarHide = isQSBarHide;
	}   
    
    public boolean getIsQSBarHide(){
    	return isQSBarHide;
    }
    
    public void setQSBarGone()
    {
    ...
    public void showSearchBar(boolean animated) {
        /* 2012-09-05 add by ChenYidong SWITCHUI-2671 begin*/
        if(isQSBarHide){
            mQSBSearchBar.setVisibility(View.GONE);
            return;
        }
