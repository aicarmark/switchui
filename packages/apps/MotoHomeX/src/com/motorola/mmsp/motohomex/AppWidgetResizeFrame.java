...
public class AppWidgetResizeFrame extends FrameLayout {
    ...
    static void updateWidgetSizeRanges(AppWidgetHostView widgetView, Launcher launcher,
        ...
        /*2012-8-3, add by bvq783 to avoid crash when add widget*/
        try {
        /*2012-8-3, add end*/
    ...
    public void snapToWidget(boolean animate) {
        ...
        /*2012-09-05, ChenYidong, for SWITCHUI-2671*/
        boolean need = true;
        if(mLauncher.getSearchBar() != null && mLauncher.getSearchBar().getIsQSBarHide()){
            need = false;
        }
        if (newY < 0 && need) {
		/*2012-09-05, end*/
