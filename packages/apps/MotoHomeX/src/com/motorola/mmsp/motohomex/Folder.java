...
// Added by e13775 at July12 2012 for organize apps' group start
import com.motorola.mmsp.motohomex.apps.GroupItem;
// Added by e13775 at July12 2012 for organize apps' group end
...
public class Folder extends LinearLayout implements DragSource, View.OnClickListener,
    ...
    public Folder(Context context, AttributeSet attrs) {
        ...
        /*2012-05-08, modified by Chen Yidong, for SWITCHUI-1010*/
        //if (sHintText == null) {
            sHintText = res.getString(R.string.folder_hint_text);
        //}
        /*2012-05-08, modified end*/
    ...
    public void onClick(View v) {
        ...
        if (tag instanceof ShortcutInfo) {
            ...
            // Added by e13775 at July12 2012 for organize apps' group start
            if (GroupItem.ACTION_START_GROUP.equals(item.intent.getAction())){
                mLauncher.showAllAppsForGroup(item.intent);
            } else {
    ...
    private void updateItemLocationsInDatabase() {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            /*2012-5-10, add by e13775 for fix SWITCHUI-1070*/
            if (DEBUG) Log.d(TAG, "info.container = " + info.container + "info.screen =" + info.screen);
            LauncherModel.moveItemInDatabase(mLauncher, info, info.container, info.screen,
                        info.cellX, info.cellY);
            /*2012-5-10, add by e13775 end*/
        }
    }
    ...
    private void replaceFolderWithFinalItem() {
        ...
        if (finalItem != null) {
            ...
            if (DEBUG) Log.d(TAG, "createShortcut: finalItem.container = " 
                    + finalItem.container + " finalItem.screen= " + finalItem.screen);
            /*2012-5-10, add by e13775 end*/
