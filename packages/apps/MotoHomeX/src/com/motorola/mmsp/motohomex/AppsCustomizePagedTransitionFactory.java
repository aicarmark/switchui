...
public class AppsCustomizePagedTransitionFactory extends TransitionFactory {
    public AppsCustomizePagedTransitionFactory(Context context, String key) {
        super(context, key);
    ...
    public PagedTransition creatPagedTransition(int type) {
        ...
        case 0:
            return PagedTransitionBoxIn.getInstance();   //PagedTransitionDefault.getInstance();
        case 1:
