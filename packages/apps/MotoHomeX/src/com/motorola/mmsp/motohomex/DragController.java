...
/*2012-8-20, add by bvq783 for dragging*/
...
public class DragController {
    ...
    public void cancelDrag() {
        if (mDragging) {
            ...
            //2012-09-07, ChenYidong for SWITCHUI-2722, update the occupied of celllayout
            if(mDragObject.dragSource instanceof Workspace && mDragObject.dragInfo != null
                    && mDragObject.dragInfo instanceof ItemInfo){
                ItemInfo info = (ItemInfo)mDragObject.dragInfo;
                Workspace ws = (Workspace)mDragObject.dragSource;
                View v = ws.getChildAt(info.screen);
                if(v != null && v instanceof CellLayout){
                    CellLayout cell = (CellLayout)v;
                    ViewGroup child = cell.getShortcutsAndWidgets();
                    if(child != null){
                        for(int i = 0; i < child.getChildCount(); i++){
                            View view = child.getChildAt(i);
                            if(view != null && (view instanceof TextView
                                    || view instanceof LauncherAppWidgetHostView || view instanceof PluginWidgetHostView)){
                                cell.markCellsAsOccupiedForView(view);
                            }
                        }
                    }
                }
    ...
    public void onAppsRemoved(ArrayList<ApplicationInfo> apps, Context context) {
        ...
        if (mDragObject != null) {
            /*2012-04-24, Chen Yidong, for SWITCHUI-774, a null point error*/
          try{
            ...
            if (rawDragInfo instanceof ShortcutInfo) {
                ...
                Log.i(TAG, "catch exception in onAppsRemoved");
          }
          /*2012-04-24, end*/
        }
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                Log.d("Drag", "DragController onInterceptTouchEvent, action up");
                mLastTouchUpTime = System.currentTimeMillis();
                if (mDragging) {
                    /*2012-05-14, Chen Yidong, for switchui-1098*/
                    //2012-05-23,modified by Chen Yidong for true SWITCHUI-1233
                    if(true || mLauncher.getSearchBar().getIsQSBarHide()){
                        if(mLauncher.getWorkspace().isSwitchingState()){
                            mLauncher.getWorkspace().setSwitchingState(false);
                        }
                        Log.d("Drag", "DragController onIntercept to handle move event");
                        handleMoveEvent(dragLayerX, dragLayerY);
                        /*2012-05-15, Chen Yidong for switchui-1112*/
                        if(mLastDropTarget instanceof DeleteDropTarget){
                            ((DeleteDropTarget) mLastDropTarget).mActive = false;
                            mLastDropTarget.onDragExit(mDragObject);
                        }
                        /*2012-05-15, end*/
		    }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        case MotionEvent.ACTION_MOVE:
            ...
            break;
        case MotionEvent.ACTION_UP:
            Log.d("Drag", "DragController onTouchEvent, action up");
	        /*2012-06-27,added by Chen Yidong for true SWITCHUI-1627*/
            ...
            Log.d("Drag", "DragController onTouchEvent to handle move event");
            handleMoveEvent(dragLayerX, dragLayerY);
            mHandler.removeCallbacks(mScrollRunnable);
    ...
    private void drop(float x, float y) {
        ...
        if (dropTarget != null) {
            ...
            /*2012-09-06, add by ChenYidong for switchui-2719*/
            try {
                ...
                Log.e(TAG, "meet nullpointer when on drop, e:"+ex);
            } catch (ArrayIndexOutOfBoundsException ex2){
                Log.e(TAG, "meet ArrayIndexOutOfBoundsException when on drop, e:"+ex2);
            }
            /*2012-09-06, add end*/
        }
        /*2012-09-06, add by ChenYidong for switchui-2719*/
        try {
            ...
            Log.e(TAG, "meet nullpointer when on dropcompleted, e:"+ex);
        } catch (ArrayIndexOutOfBoundsException ex2){
            Log.e(TAG, "meet ArrayIndexOutOfBoundsException when on dropcompleted, e:"+ex2);
        }
        /*2012-09-06, add end*/
    }
