...
/**
 * This class extends {@link CommandHandler} and handles List command
 *
 * @author wkh346
 *
 */
public class LocationListHandler extends CommandHandler implements LocConstants {
    ...
    protected String executeCommand(Context context, Intent intent) {
        context.sendBroadcast(getListResponse(context, new ArrayList<String>(),
                ...
                context.getString(R.string.location)), PERM_CONDITION_PUBLISHER_ADMIN);
        return SUCCESS;
    }
