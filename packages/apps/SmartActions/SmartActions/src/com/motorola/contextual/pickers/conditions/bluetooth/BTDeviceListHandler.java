 ...
 * ------------- ---------- ----------------- ------------------------------
 * a18491       2012/03/06  NA                Initial version of BTDeviceListHandler
 *
 */
...
public final class BTDeviceListHandler extends  CommandHandler {

    @SuppressWarnings("unused")
	private final static String LOG_TAG = BTDeviceListHandler.class.getSimpleName();
    ...
    private void constructAndPostResponse(Context context, Intent intent) {
        ...
        responseIntent.putExtra(EXTRA_CONFIG_ITEMS, BTDeviceDetailComposer.getConfigItems(context));        
        responseIntent.putExtra(EXTRA_NEW_STATE_TITLE, BTDeviceDetailComposer.getName(context));
