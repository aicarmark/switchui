...
public class LbsBatteryStateMonitor extends CommonStateMonitor implements Constants {
    ...
    private class Receiver extends BaseInferenceReceiver{
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            intent.putExtra(Constants.IDENTIFIER, Constants.RULE_KEY_LBS);
