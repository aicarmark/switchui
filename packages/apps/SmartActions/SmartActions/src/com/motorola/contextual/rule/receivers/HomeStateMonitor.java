...
public class HomeStateMonitor extends CommonStateMonitor implements Constants {
    ...
    public ArrayList<String> getStateMonitorIdentifiers() {
        ...
        actions.add(CoreConstants.LOCATION_INFERRED_ACTION);
    ...
    private class Receiver extends BaseInferenceReceiver{
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            intent.putExtra(Constants.IDENTIFIER, Constants.RULE_KEY_HOME);
