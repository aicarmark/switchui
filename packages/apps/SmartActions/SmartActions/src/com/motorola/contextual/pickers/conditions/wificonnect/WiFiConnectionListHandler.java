 ...
 * handling List command and broadcasting {@link Constants#LIST_RESPONSE} intent
 *
 * @author wkh346
 *
 */
public class WiFiConnectionListHandler extends CommandHandler implements
    ...
    protected String executeCommand(Context context, Intent intent) {
        context.sendBroadcast(getListResponse(context, new ArrayList<String>(),
                ...
                context.getString(R.string.wificonnectionwithaddress)), PERM_CONDITION_PUBLISHER_ADMIN);
        return SUCCESS;
    }

    /**
     * This method constructs the {@link Constants#LIST_RESPONSE} intent
     *
     * @param context
     ...
     * @return - the {@link Constants#LIST_RESPONSE} intent
     */
