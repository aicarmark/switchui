 ...
 *
 */
public interface RulesBuilderInterface {
	 ...
	 */
	public PublisherList fetchActionListToGrey(long rule_id, ActionPublisherList actionPubList);
	 ...
	 */
	public PublisherList fetchConditionListToGrey(long rule_id, ConditionPublisherList conditionPubList);
