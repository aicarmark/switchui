 ...
 * ------------- ---------- ----------------- ------------------------------
 * a21693        2012/06/16  NA                Initial version
 *
 */
...
/**
 * This class extends CommonStateMonitor for BS inferencing
 *
 * <CODE><PRE>
 *
 * CLASS:
...
public class BsBatteryStateMonitor extends CommonStateMonitor implements Constants {
    ...
    private class Receiver extends BaseInferenceReceiver{
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            intent.putExtra(Constants.IDENTIFIER, Constants.RULE_KEY_BS);
