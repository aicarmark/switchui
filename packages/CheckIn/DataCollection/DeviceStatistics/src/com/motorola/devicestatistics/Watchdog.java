...
final class SystemDependency implements DeviceStatsConstants {
    /**
     * true if debug logs should be printed to logcat
     */
    final static boolean DUMP = GLOBAL_DUMP;
     ...
     */
    final static String PACKAGE_COMMON_PREFIX = "com.motorola.devicestatistics";

    /**
     * Tag used for logcat logs
     */
    final static String TAG = "DeviceStatisticsWatchdog";
     ...
     */
    final static String PREF_FILE = "DsWatchdog";
    ...
    static final Object getObjectFromString(String encoded) {
        return DevStatUtils.deSerializeObject(encoded, long[].class);
    }
    ...
    static final String getObjectAsString(long[] object) {
        return DevStatUtils.serializeObject(object);
    }
}
